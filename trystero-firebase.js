...
class M {
  ...
  getOrInitializeService({ instanceIdentifier: e, options: t = {} }) {
    ...
    if (
      !n &&
      this.component &&
      ((n = this.component.instanceFactory(this.container, { instanceIdentifier: ((i = e), i === F ? void 0 : i), options: t })),
...
const W = { debug: U.DEBUG, verbose: U.VERBOSE, info: U.INFO, warn: U.WARN, error: U.ERROR, silent: U.SILENT },
  j = U.INFO,
  B = { [U.DEBUG]: "log", [U.VERBOSE]: "log", [U.INFO]: "info", [U.WARN]: "warn", [U.ERROR]: "error" },
  H = (e, t, ...n) => {
...
class z {
  constructor(e) {
    (this.name = e), (this._logLevel = j), (this._logHandler = H), (this._userLogHandler = null);
  }
  get logLevel() {
...
const $ = (e, t) => t.some((t) => e instanceof t);
let V, Y;
const K = new WeakMap(),
  G = new WeakMap(),
  Q = new WeakMap(),
...
function ee(e) {
  return e !== IDBDatabase.prototype.transaction || "objectStoreNames" in IDBTransaction.prototype
    ? (Y || (Y = [IDBCursor.prototype.advance, IDBCursor.prototype.continue, IDBCursor.prototype.continuePrimaryKey])).includes(e)
      ? function (...t) {
...
Z = ((e) => ({ ...e, get: (t, n, i) => ae(t, n) || e.get(t, n, i), has: (t, n) => !!ae(t, n) || e.has(t, n) }))(Z);
class he {
  constructor(e) {
    this.container = e;
  }
...
const le = "@firebase/app",
  ...
  pe = "@firebase/analytics-compat",
  _e = "@firebase/analytics",
  fe = "@firebase/app-check-compat",
  me = "@firebase/app-check",
  ge = "@firebase/auth",
  ye = "@firebase/auth-compat",
  ve = "@firebase/database",
  Ce = "@firebase/database-compat",
  be = "@firebase/functions",
  we = "@firebase/functions-compat",
  Se = "@firebase/installations",
  Ee = "@firebase/installations-compat",
  Te = "@firebase/messaging",
  Ie = "@firebase/messaging-compat",
  ke = "@firebase/performance",
  xe = "@firebase/performance-compat",
  Ne = "@firebase/remote-config",
  Re = "@firebase/remote-config-compat",
  Pe = "@firebase/storage",
  De = "@firebase/storage-compat",
  Ae = "@firebase/firestore",
  Oe = "@firebase/vertexai-preview",
  Le = "@firebase/firestore-compat",
  Fe = "firebase",
  Me = "[DEFAULT]",
  qe = {
    [le]: "fire-core",
    [ue]: "fire-core-compat",
    [_e]: "fire-analytics",
    [pe]: "fire-analytics-compat",
    [me]: "fire-app-check",
    [fe]: "fire-app-check-compat",
    [ge]: "fire-auth",
    [ye]: "fire-auth-compat",
    [ve]: "fire-rtdb",
    [Ce]: "fire-rtdb-compat",
...
function He(e) {
  const t = e.name;
  if (je.has(t)) return de.debug(`There were multiple attempts to register component ${t}.`), !1;
  je.set(t, e);
  for (const t of Ue.values()) Be(t, e);
  for (const t of We.values()) Be(t, e);
  return !0;
}
const ze = new C("app", "Firebase", {
...
function Ve(e, t = {}) {
  ...
  const i = Object.assign({ name: Me, automaticDataCollectionEnabled: !1 }, t),
    s = i.name;
  if ("string" != typeof s || !s) throw ze.create("bad-app-name", { appName: s + "" });
  if ((n || (n = f()), !n)) throw ze.create("no-options");
  const r = Ue.get(s);
  if (r) {
    if (N(n, r.options) && N(i, r.config)) return r;
    throw ze.create("duplicate-app", { appName: s });
  }
  const o = new q(s);
  for (const e of je.values()) o.addComponent(e);
  const a = new $e(n, i, o);
  return Ue.set(s, a), a;
}
function Ye(e, t, n) {
  var i;
  let s = null !== (i = qe[e]) && void 0 !== i ? i : e;
  n && (s += "-" + n);
  const r = s.match(/\s|\//),
    o = t.match(/\s|\//);
  if (r || o) {
  ...
  He(new L(s + "-version", () => ({ library: s, version: t }), "VERSION"));
}
const Ke = "firebase-heartbeat-database",
  Ge = 1,
  Qe = "firebase-heartbeat-store";
let Je = null;
function Xe() {
  return (
    Je ||
      (Je = (function (e, t, { blocked: n, upgrade: i, blocking: s, terminated: r } = {}) {
        ...
        throw ze.create("idb-open", { originalErrorMessage: e.message });
      })),
    Je
  );
}
async function Ze(e, t) {
  try {
    const n = (await Xe()).transaction(Qe, "readwrite"),
      i = n.objectStore(Qe);
    await i.put(t, et(e)), await n.done;
  } catch (e) {
    if (e instanceof v) de.warn(e.message);
    else {
      const t = ze.create("idb-set", { originalErrorMessage: null == e ? void 0 : e.message });
      de.warn(t.message);
    }
  }
}
...
class tt {
  constructor(e) {
    ...
    (this._storage = new it(t)), (this._heartbeatsCachePromise = this._storage.read().then((e) => ((this._heartbeatsCache = e), e)));
  }
  async triggerHeartbeat() {
    ...
    if (
      (null != (null === (e = this._heartbeatsCache) || void 0 === e ? void 0 : e.heartbeats) ||
        ((this._heartbeatsCache = await this._heartbeatsCachePromise), null != (null === (t = this._heartbeatsCache) || void 0 === t ? void 0 : t.heartbeats))) &&
  ...
  async getHeartbeatsHeader() {
    ...
    const t = nt(),
      { heartbeatsToSend: n, unsentEntries: i } = (function (e, t = 1024) {
        ...
        for (const s of e) {
          ...
          if (e) {
            if ((e.dates.push(s.date), st(n) > t)) {
              e.dates.pop();
              break;
            }
          } else if ((n.push({ agent: s.agent, dates: [s.date] }), st(n) > t)) {
            n.pop();
            break;
          }
          i = i.slice(1);
    ...
    return (
      ...
      i.length > 0 ? ((this._heartbeatsCache.heartbeats = i), await this._storage.overwrite(this._heartbeatsCache)) : ((this._heartbeatsCache.heartbeats = []), this._storage.overwrite(this._heartbeatsCache)),
      s
    );
  }
}
...
class it {
  ...
  async read() {
    if (await this._canUseIndexedDBPromise) {
      const e = await (async function (e) {
        try {
          const t = (await Xe()).transaction(Qe),
            n = await t.objectStore(Qe).get(et(e));
          return await t.done, n;
        } catch (e) {
          if (e instanceof v) de.warn(e.message);
          else {
            const t = ze.create("idb-get", { originalErrorMessage: null == e ? void 0 : e.message });
            de.warn(t.message);
          }
        }
      })(this.app);
  ...
  async overwrite(e) {
    ...
    if (await this._canUseIndexedDBPromise) {
      ...
      return Ze(this.app, { lastSentHeartbeatDate: null !== (t = e.lastSentHeartbeatDate) && void 0 !== t ? t : n.lastSentHeartbeatDate, heartbeats: e.heartbeats });
    }
  }
  async add(e) {
    var t;
    if (await this._canUseIndexedDBPromise) {
      const n = await this.read();
      return Ze(this.app, { lastSentHeartbeatDate: null !== (t = e.lastSentHeartbeatDate) && void 0 !== t ? t : n.lastSentHeartbeatDate, heartbeats: [...n.heartbeats, ...e.heartbeats] });
    }
  }
}
function st(e) {
...
var rt;
(rt = ""), He(new L("platform-logger", (e) => new he(e), "PRIVATE")), He(new L("heartbeat", (e) => new tt(e), "PRIVATE")), Ye(le, ce, rt), Ye(le, ce, "esm2017"), Ye("fire-js", "");
Ye("firebase", "10.12.4", "app");
const ot = "@firebase/database",
  at = "1.0.6";
let ht = "";
class lt {
  constructor(e) {
  ...
  set(e, t) {
    null == t ? this.domStorage_.removeItem(this.prefixedName_(e)) : this.domStorage_.setItem(this.prefixedName_(e), S(t));
  }
  get(e) {
...
const dt = (e) => {
    try {
      if ("undefined" != typeof window && void 0 !== window[e]) {
        const t = window[e];
        return t.setItem("firebase:sentinel", "cache"), t.removeItem("firebase:sentinel"), new lt(t);
      }
    } catch (e) {}
    return new ct();
  },
  ut = dt("localStorage"),
  pt = dt("sessionStorage"),
  _t = new z("@firebase/database"),
  ft = (() => {
    let e = 1;
    return () => e++;
  })(),
    ...
    const t = ((e) => {
        ...
        for (let s = 0; s < e.length; s++) {
          ...
          r < 128
            ...
            : r < 65536
            ? ((t[i++] = (r >> 12) | 224), (t[i++] = ((r >> 6) & 63) | 128), (t[i++] = (63 & r) | 128))
            : ((t[i++] = (r >> 18) | 240), (t[i++] = ((r >> 12) & 63) | 128), (t[i++] = ((r >> 6) & 63) | 128), (t[i++] = (63 & r) | 128));
        }
        return t;
      })(e),
      i = new P();
  ...
  gt = (...e) => {
    ...
    for (let n = 0; n < e.length; n++) {
      const i = e[n];
      Array.isArray(i) || (i && "object" == typeof i && "number" == typeof i.length) ? (t += gt.apply(null, i)) : (t += "object" == typeof i ? S(i) : i), (t += " ");
    }
    return t;
  };
let yt = null,
...
const Ct = (...e) => {
    var t;
    if ((!0 === vt && ((vt = !1), null === yt && !0 === pt.get("logging_enabled") && (n(!t, "Can't turn on custom loggers persistently."), (_t.logLevel = U.VERBOSE), (yt = _t.log.bind(_t)))), yt)) {
      const t = gt.apply(null, e);
      yt(t);
    }
  },
  bt = (e) => (...t) => {
  ...
  wt = (...e) => {
    const t = "FIREBASE INTERNAL ERROR: " + gt(...e);
    _t.error(t);
  },
  St = (...e) => {
    const t = "FIREBASE FATAL ERROR: " + gt(...e);
    throw (_t.error(t), Error(t));
  },
  Et = (...e) => {
    const t = "FIREBASE WARNING: " + gt(...e);
    _t.warn(t);
  },
  Tt = (e) => "number" == typeof e && (e != e || e === 1 / 0 || e === -1 / 0),
  It = "[MIN_NAME]",
  kt = "[MAX_NAME]",
  xt = (e, t) => {
    if (e === t) return 0;
    if (e === It || t === kt) return -1;
    if (t === It || e === kt) return 1;
    {
      const n = Ft(e),
        i = Ft(t);
  ...
  Nt = (e, t) => (e === t ? 0 : e < t ? -1 : 1),
  Rt = (e, t) => {
    if (t && e in t) return t[e];
    throw Error("Missing required key (" + e + ") in object: " + S(t));
  },
  Pt = (e) => {
    if ("object" != typeof e || null === e) return S(e);
    const t = [];
    for (const n in e) t.push(n);
    t.sort();
    let n = "{";
    for (let i = 0; i < t.length; i++) 0 !== i && (n += ","), (n += S(t[i])), (n += ":"), (n += Pt(e[t[i]]));
    return (n += "}"), n;
  },
  Dt = (e, t) => {
    const n = e.length;
...
const Ot = (e) => {
  n(!Tt(e), "Invalid JSON number");
  const t = 1023;
  let i, s, r, o, a;
  0 === e
    ? ((s = 0), (r = 0), (i = 1 / e == -1 / 0 ? 1 : 0))
    : ((i = e < 0), (e = Math.abs(e)) >= Math.pow(2, -1022) ? ((o = Math.min(Math.floor(Math.log(e) / Math.LN2), t)), (s = o + t), (r = Math.round(e * Math.pow(2, 52 - o) - Math.pow(2, 52)))) : ((s = 0), (r = Math.round(e / 5e-324))));
  const h = [];
...
const Lt = RegExp("^-?(0*)\\d{1,10}$"),
  ...
  Mt = (e) => {
    try {
      ...
      setTimeout(() => {
        const t = e.stack || "";
        throw (Et("Exception was thrown by user callback.", t), e);
      }, 0);
    }
  },
  qt = (e, t) => {
...
class Ut {
  ...
  notifyForInvalidToken() {
    Et(`Provided AppCheck credentials for the app named "${this.appName_}" are invalid. This usually indicates your app was not initialized correctly.`);
  }
}
class Wt {
  constructor(e, t, n) {
  ...
  getToken(e) {
    return this.auth_
      ? this.auth_.getToken(e).catch((e) => (e && "auth/token-not-initialized" === e.code ? (Ct("Got auth/token-not-initialized error.  Treating as null token."), null) : Promise.reject(e)))
      : new Promise((t, n) => {
          setTimeout(() => {
...
class Vt {
  constructor(e, t, n, i, s = !1, r = "", o = !1, a = !1) {
    (this.secure = t),
      ...
      (this.internalHost = ut.get("host:" + e) || this._host);
  }
  isCacheableHost() {
  ...
  set host(e) {
    e !== this.internalHost && ((this.internalHost = e), this.isCacheableHost() && ut.set("host:" + this._host, this.internalHost));
  }
  toString() {
...
function Yt(e, t, i) {
  let s;
  if ((n("string" == typeof t, "typeof type must == string"), n("object" == typeof i, "typeof params must == object"), t === zt)) s = (e.secure ? "wss://" : "ws://") + e.internalHost + "/.ws?";
  else {
    if (t !== $t) throw Error("Unknown connection type: " + t);
...
class en {
  constructor(e, t, n, i, s, r, o) {
    (this.connId = e),
      ...
      (this.log_ = bt(e)),
      (this.stats_ = Jt(t)),
      (this.urlFn = (e) => (this.appCheckToken && (e[Ht] = this.appCheckToken), Yt(t, $t, e)));
  }
  open(e, t) {
    (this.curSegmentNum = 0),
      (this.onDisconnect_ = t),
      (this.myPacketOrderer = new Xt(e)),
      (this.isClosed_ = !1),
      ...
      ((e) => {
        ...
        this.scriptTagHolder = new tn(
          (...e) => {
            const [t, n, i, s, r] = e;
            if ((this.incrementIncomingBytes_(e), this.scriptTagHolder))
              if ((this.connectTimeoutTimer_ && (clearTimeout(this.connectTimeoutTimer_), (this.connectTimeoutTimer_ = null)), (this.everConnected_ = !0), t === Zt)) (this.id = n), (this.password = i);
              else {
        ...
        (e[Zt] = "t"),
          ...
          this.appCheckToken && (e[Ht] = this.appCheckToken),
          "undefined" != typeof location && location.hostname && Bt.test(location.hostname) && (e.r = "f");
...
class tn {
  constructor(e, t, n, i) {
    ...
    {
      (this.uniqueCallbackIdentifier = ft()), (window["pLPCommand" + this.uniqueCallbackIdentifier] = e), (window["pRTLPCB" + this.uniqueCallbackIdentifier] = t), (this.myIFrame = tn.createIFrame_());
      let n = "";
      ...
      try {
        ...
        Ct("frame writing exception"), e.stack && Ct(e.stack), Ct(e);
      }
    }
  }
  static createIFrame_() {
    ...
    try {
      e.contentWindow.document || Ct("No IE domain setting required");
    } catch (t) {
    ...
    setTimeout(() => {
      try {
        ...
        (n.type = "text/javascript"),
          ...
          (n.onerror = () => {
            Ct("Long-poll script failed to load: " + e), (this.sendNewPolls = !1), this.close();
          }),
...
class sn {
  constructor(e, t, n, i, s, r, o) {
    (this.connId = e),
      ...
      (this.bytesSent = 0),
      (this.bytesReceived = 0),
      (this.log_ = bt(this.connId)),
      (this.stats_ = Jt(t)),
      (this.connURL = sn.connectionURL_(t, r, o, i, n)),
      (this.nodeAdmin = t.nodeAdmin);
  }
  static connectionURL_(e, t, n, i, s) {
    const r = { v: "5" };
    return "undefined" != typeof location && location.hostname && Bt.test(location.hostname) && (r.r = "f"), t && (r.s = t), n && (r.ls = n), i && (r[Ht] = i), s && (r.p = s), Yt(e, zt, r);
  }
  open(e, t) {
    (this.onDisconnect = t), (this.onMessage = e), this.log_("Websocket connecting to " + this.connURL), (this.everConnected_ = !1), ut.set("previous_websocket_failure", !0);
    try {
      let e;
      y(), (this.mySock = new nn(this.connURL, [], e));
    } catch (e) {
  ...
  static isAvailable() {
    ...
    return !e && null !== nn && !sn.forceDisallow_;
  }
...
(sn.responsesRequiredToBeHealthy = 2), (sn.healthyTimeout = 3e4);
class rn {
  constructor(e) {
  ...
  initTransports_(e) {
    const t = sn && sn.isAvailable();
    let n = t && !sn.previouslyFailed();
    if ((e.webSocketOnly && (t || Et("wss:// URL used, but browser isn't known to support websockets.  Trying anyway."), (n = !0)), n)) this.transports_ = [sn];
    else {
      const e = (this.transports_ = []);
      for (const t of rn.ALL_TRANSPORTS) t && t.isAvailable() && e.push(t);
      rn.globalTransportInitialized_ = !0;
    }
  }
  initialTransport() {
...
rn.globalTransportInitialized_ = !1;
class on {
  constructor(e, t, n, i, s, r, o, a, h, l) {
    (this.id = e),
      ...
      (this.state_ = 0),
      (this.log_ = bt("c:" + this.id + ":")),
      (this.transportManager_ = new rn(t)),
    ...
    if ("d" in e) {
      ...
      if ("h" === t) {
        ...
        "s" === t
          ...
          : wt("Unknown control packet command: " + t);
    }
  }
  onHandshake_(e) {
    const t = e.ts,
      n = e.v,
      i = e.h;
    (this.sessionId = e.s), (this.repoInfo_.host = i), 0 === this.state_ && (this.conn_.start(), this.onConnectionEstablished_(this.conn_, t), "5" !== n && Et("Protocol version mismatch detected"), this.tryStartUpgrade_());
  }
  tryStartUpgrade_() {
...
function mn(e) {
  let t = e.pieceNum_;
  return t < e.pieces_.length && t++, new un(e.pieces_, t);
}
function gn(e) {
...
function Cn(e, t) {
  ...
  if (t instanceof un) for (let e = t.pieceNum_; e < t.pieces_.length; e++) n.push(t.pieces_[e]);
  else {
    const e = t.split("/");
...
class In {
  constructor(e, t) {
    (this.errorPrefix_ = t), (this.parts_ = yn(e, 0)), (this.byteLength_ = Math.max(1, this.parts_.length));
    for (let e = 0; e < this.parts_.length; e++) this.byteLength_ += A(this.parts_[e]);
    kn(this);
  }
}
function kn(e) {
  if (e.byteLength_ > dn) throw Error(e.errorPrefix_ + "has a key path longer than " + dn + " bytes (" + e.byteLength_ + ").");
  if (e.parts_.length > cn) throw Error(e.errorPrefix_ + "path specified exceeds the maximum depth that can be written (" + cn + ") or object contains a cycle " + xn(e));
}
function xn(e) {
...
class Pn extends an {
  constructor(e, t, n, i, s, r, o, a) {
    if (
      ...
      (this.id = Pn.nextPersistentConnectionId_++),
      (this.log_ = bt("p:" + this.id + ":")),
    ...
    Nn.getInstance().on("visible", this.onVisible_, this), -1 === e.host.indexOf("fblocal") && ln.getInstance().on("online", this.onOnline_, this);
  }
  sendRequest(e, t, i) {
    const s = ++this.requestNumber_,
      r = { r: s, a: e, b: t };
    this.log_(S(r)), n(this.connected_, "sendRequest call when we're not connected not allowed."), this.realtime_.sendRequest(r), i && (this.requestCBHash_[s] = i);
  }
  get(e) {
  ...
  listen(e, t, i, s) {
    ...
    this.log_("Listen called for " + o + " " + r),
      ...
      n(e._queryParams.isDefault() || !e._queryParams.loadsAllData(), "listen() called for non-default but complete query"),
      n(!this.listens.get(o).has(r), "listen() called twice for same path/queryId.");
    const a = { onComplete: s, hashFn: t, query: e, tag: i };
    ...
    if (e && "object" == typeof e && T(e, "w")) {
      ...
      if (Array.isArray(n) && ~n.indexOf("no_index")) {
        const e = '".indexOn": "' + t._queryParams.getIndex().toString() + '"',
          n = t._path.toString();
        Et(`Using an unspecified index. Your data will be downloaded and filtered on the client. Consider adding ${e} at ` + n + " to your security rules for better performance.");
      }
    }
  }
  refreshAuthToken(e) {
  ...
  putInternal(e, t, n, i, s) {
    this.initConnection_();
    const r = { p: t, d: n };
    void 0 !== s && (r.h = s), this.outstandingPuts_.push({ action: e, request: r, onComplete: i }), this.outstandingPutCount_++;
  ...
  onDataPush_(e, t) {
    this.log_("handleServerMessage", e, t),
      "d" === e
        ...
        : wt("Unrecognized action received from server: " + S(e) + "\nAre you using the latest client?");
  }
  onReady_(e, t) {
  ...
  async establishConnection_() {
    if (this.shouldReconnect_()) {
      ...
      const e = this.onDataMessage_.bind(this),
        ...
        s = this.id + ":" + Pn.nextConnectionId_++,
      ...
      try {
        ...
        o
          ? Ct("getToken() completed but was canceled")
          : (Ct("getToken() completed. Creating connection."),
            (this.authToken_ = n && n.accessToken),
            ...
            (a = new on(
              ...
              i,
              (e) => {
                Et(e + " (" + this.repoInfo_.toString() + ")"), this.interrupt("server_kill");
              },
              r
            )));
      } catch (e) {
        this.log_("Failed to get token: " + e), o || (this.repoInfo_.nodeAdmin && Et(e), h());
      }
    }
  }
  interrupt(e) {
    Ct("Interrupting connection for reason: " + e),
  ...
  resume(e) {
    Ct("Resuming connection for reason: " + e), delete this.interruptReasons_[e], k(this.interruptReasons_) && ((this.reconnectDelay_ = Rn), this.realtime_ || this.scheduleConnect_(0));
  }
  handleTimestamp_(e) {
  ...
  onAppCheckRevoked_(e, t) {
    Ct("App check token revoked: " + e + "/" + t),
      (this.appCheckToken_ = null),
      (this.forceTokenRefresh_ = !0),
  ...
  sendConnectStats_() {
    const e = {};
    (e["sdk.js." + ht.replace(/\./g, "-")] = 1), g() ? (e["framework.cordova"] = 1) : "object" == typeof navigator && "ReactNative" === navigator.product && (e["framework.reactnative"] = 1), this.reportStats(e);
  }
  shouldReconnect_() {
    const e = ln.getInstance().currentlyOnline();
    return k(this.interruptReasons_) && e;
  }
}
(Pn.nextPersistentConnectionId_ = 0), (Pn.nextConnectionId_ = 0);
class Dn {
  constructor(e, t) {
...
class Ln extends An {
  ...
  makePost(e, t) {
    return n("string" == typeof e, "KeyIndex indexValue must always be a string."), new Dn(e, On);
  }
  toString() {
    return ".key";
  }
...
class qn {
  constructor(e, t, n, i, s) {
    (this.key = e), (this.value = t), (this.color = null != n ? n : qn.RED), (this.left = null != i ? i : Un.EMPTY_NODE), (this.right = null != s ? s : Un.EMPTY_NODE);
  }
  copy(e, t, n, i, s) {
    return new qn(null != e ? e : this.key, null != t ? t : this.value, null != n ? n : this.color, null != i ? i : this.left, null != s ? s : this.right);
  }
  count() {
  ...
  removeMin_() {
    if (this.left.isEmpty()) return Un.EMPTY_NODE;
    let e = this;
  ...
  remove(e, t) {
    ...
    if (((n = this), t(e, n.key) < 0)) n.left.isEmpty() || n.left.isRed_() || n.left.left.isRed_() || (n = n.moveRedLeft_()), (n = n.copy(null, null, null, n.left.remove(e, t), null));
      ...
      if ((n.left.isRed_() && (n = n.rotateRight_()), n.right.isEmpty() || n.right.isRed_() || n.right.left.isRed_() || (n = n.moveRedRight_()), 0 === t(e, n.key))) {
        if (n.right.isEmpty()) return Un.EMPTY_NODE;
  ...
  rotateLeft_() {
    const e = this.copy(null, null, qn.RED, null, this.right.left);
    return this.right.copy(null, null, this.color, e, null);
  }
  rotateRight_() {
    const e = this.copy(null, null, qn.RED, this.left.right, null);
...
(qn.RED = !0), (qn.BLACK = !1);
class Un {
  constructor(e, t = Un.EMPTY_NODE) {
    (this.comparator_ = e), (this.root_ = t);
  }
  insert(e, t) {
    return new Un(this.comparator_, this.root_.insert(e, t, this.comparator_).copy(null, null, qn.BLACK, null, null));
  }
  remove(e) {
    return new Un(this.comparator_, this.root_.remove(e, this.comparator_).copy(null, null, qn.BLACK, null, null));
  }
  get(e) {
    let t,
      n = this.root_;
  ...
  getIterator(e) {
    return new Mn(this.root_, null, this.comparator_, !1, e);
  }
  getIteratorFrom(e, t) {
    return new Mn(this.root_, e, this.comparator_, !1, t);
  }
  getReverseIteratorFrom(e, t) {
    return new Mn(this.root_, e, this.comparator_, !0, t);
  }
  getReverseIterator(e) {
    return new Mn(this.root_, null, this.comparator_, !0, e);
  }
}
function Wn(e, t) {
  return xt(e.name, t.name);
...
let Bn;
Un.EMPTY_NODE = new (class {
  copy(e, t, n, i, s) {
    return this;
  }
  insert(e, t, n) {
    return new qn(e, t, null);
  }
  remove(e, t) {
    return this;
  }
...
const Hn = (e) => ("number" == typeof e ? "number:" + Ot(e) : "string:" + e),
  zn = (e) => {
    if (e.isLeafNode()) {
      const t = e.val();
      n("string" == typeof t || "number" == typeof t || ("object" == typeof t && T(t, ".sv")), "Priority must be a string or number.");
    } else n(e === Bn || e.isEmpty(), "priority of unexpected type.");
    n(e === Bn || e.getPriority().isEmpty(), "Priority nodes can't have a priority of their own.");
  };
let $n, Vn, Yn;
class Kn {
  constructor(e, t = Kn.__childrenNodeConstructor.EMPTY_NODE) {
    (this.value_ = e), (this.priorityNode_ = t), (this.lazyHash_ = null), n(void 0 !== this.value_ && null !== this.value_, "LeafNode shouldn't be created with null/undefined value."), zn(this.priorityNode_);
  }
  ...
  getChild(e) {
    return bn(e) ? this : ".priority" === _n(e) ? this.priorityNode_ : Kn.__childrenNodeConstructor.EMPTY_NODE;
  }
  hasChild() {
    return !1;
  }
  ...
  updateChild(e, t) {
    ...
    return null === i
      ? t
      : t.isEmpty() && ".priority" !== i
      ? this
      : (n(".priority" !== i || 1 === fn(e), ".priority must be the last token in a path"), this.updateImmediateChild(i, Kn.__childrenNodeConstructor.EMPTY_NODE.updateChild(mn(e), t)));
  }
  isEmpty() {
    return !1;
  }
  ...
  hash() {
    if (null === this.lazyHash_) {
      ...
      (e += t + ":"), (e += "number" === t ? Ot(this.value_) : this.value_), (this.lazyHash_ = mt(e));
    }
  ...
  compareTo(e) {
    return e === Kn.__childrenNodeConstructor.EMPTY_NODE ? 1 : e instanceof Kn.__childrenNodeConstructor ? -1 : (n(e.isLeafNode(), "Unknown node type"), this.compareToLeafNode_(e));
  }
  compareToLeafNode_(e) {
    const t = typeof e.value_,
      i = typeof this.value_,
      s = Kn.VALUE_TYPE_ORDER.indexOf(t),
      r = Kn.VALUE_TYPE_ORDER.indexOf(i);
...
Kn.VALUE_TYPE_ORDER = ["object", "boolean", "number", "string"];
const Gn = new (class extends An {
    compare(e, t) {
      const n = e.node.getPriority(),
        i = t.node.getPriority(),
        s = n.compareTo(i);
      return 0 === s ? xt(e.name, t.name) : s;
    }
    isDefinedOn(e) {
    ...
    maxPost() {
      return new Dn(kt, new Kn("[PRIORITY-POST]", Yn));
    }
    makePost(e, t) {
      const n = Vn(e);
      return new Dn(t, new Kn("[PRIORITY-POST]", n));
    }
    toString() {
      return ".priority";
    }
...
class Jn {
  constructor(e) {
    (this.count = parseInt(Math.log(e + 1) / Qn, 10)), (this.current_ = this.count - 1);
...
const Xn = (e, t, n, i) => {
  ...
  const s = (t, i) => {
      ...
      let o, a;
      if (0 === r) return null;
      if (1 === r) return (o = e[t]), (a = n ? n(o) : o), new qn(a, o.node, qn.BLACK, null, null);
      {
        const h = parseInt(r / 2, 10) + t,
          l = s(t, h),
          c = s(h + 1, i);
        return (o = e[h]), (a = n ? n(o) : o), new qn(a, o.node, qn.BLACK, l, c);
      }
    },
    r = ((t) => {
      let i = null,
      ...
      for (let e = 0; e < t.count; ++e) {
        ...
        n ? a(i, qn.BLACK) : (a(i, qn.BLACK), a(i, qn.RED));
      }
      return r;
    })(new Jn(e.length));
  return new Un(i || t, r);
...
class ti {
  ...
  static get Default() {
    return n(ei && Gn, "ChildrenNode.ts has not been loaded"), (Zn = Zn || new ti({ ".priority": ei }, { ".priority": Gn })), Zn;
  }
  get(e) {
    const t = I(this.indexes_, e);
    if (!t) throw Error("No index defined for " + e);
    return t instanceof Un ? t : null;
  }
  hasIndex(e) {
    return T(this.indexSet_, e.toString());
  }
  addIndex(e, t) {
    n(e !== Fn, "KeyIndex always exists and isn't meant to be added to the IndexMap.");
    const i = [];
    let s = !1;
    const r = t.getIterator(Dn.Wrap);
    let o,
      a = r.getNext();
    for (; a; ) (s = s || e.isDefinedOn(a.node)), i.push(a), (a = r.getNext());
    o = s ? Xn(i, e.getCompare()) : ei;
    const h = e.toString(),
      l = Object.assign({}, this.indexSet_);
    l[h] = e;
    const c = Object.assign({}, this.indexes_);
    return (c[h] = o), new ti(c, l);
  }
  addToIndexes(e, t) {
    const i = x(this.indexes_, (i, s) => {
      const r = I(this.indexSet_, s);
      if ((n(r, "Missing index implementation for " + s), i === ei)) {
        if (r.isDefinedOn(e.node)) {
          const n = [],
            i = t.getIterator(Dn.Wrap);
          let s = i.getNext();
          for (; s; ) s.name !== e.name && n.push(s), (s = i.getNext());
          return n.push(e), Xn(n, r.getCompare());
        }
        return ei;
      }
      {
        ...
        let s = i;
        return n && (s = s.remove(new Dn(e.name, n))), s.insert(e, e.node);
      }
    });
    return new ti(i, this.indexSet_);
  }
  removeFromIndexes(e, t) {
    const n = x(this.indexes_, (n) => {
      if (n === ei) return n;
      {
        const i = t.get(e.name);
        return i ? n.remove(new Dn(e.name, i)) : n;
      }
    });
    return new ti(n, this.indexSet_);
  }
}
let ni;
class ii {
  constructor(e, t, i) {
    (this.children_ = e),
      ...
      (this.indexMap_ = i),
      (this.lazyHash_ = null),
      this.priorityNode_ && zn(this.priorityNode_),
      this.children_.isEmpty() && n(!this.priorityNode_ || this.priorityNode_.isEmpty(), "An empty node cannot have a priority");
  }
  static get EMPTY_NODE() {
    return ni || (ni = new ii(new Un(jn), null, ti.Default));
  }
  isLeafNode() {
    return !1;
  }
  getPriority() {
    return this.priorityNode_ || ni;
  }
  updatePriority(e) {
    return this.children_.isEmpty() ? this : new ii(this.children_, e, this.indexMap_);
  }
  getImmediateChild(e) {
  ...
  getChild(e) {
    const t = _n(e);
    return null === t ? this : this.getImmediateChild(t).getChild(mn(e));
  }
  hasChild(e) {
  ...
  updateImmediateChild(e, t) {
    if ((n(t, "We should always be passing snapshot nodes"), ".priority" === e)) return this.updatePriority(t);
    {
      ...
      const r = i.isEmpty() ? ni : this.priorityNode_;
      return new ii(i, r, s);
    }
  }
  updateChild(e, t) {
    ...
    if (null === i) return t;
    {
      n(".priority" !== _n(e) || 1 === fn(e), ".priority must be the last token in a path");
      const s = this.getImmediateChild(i).updateChild(mn(e), t);
  ...
  val(e) {
    ...
    let n = 0,
      ...
      s = !0;
    if (
      (this.forEachChild(Gn, (r, o) => {
        (t[r] = o.val(e)), n++, s && ii.INTEGER_REGEXP_.test(r) ? (i = Math.max(i, Number(r))) : (s = !1);
      }),
      !e && s && i < 2 * n)
    ) {
      const e = [];
  ...
  hash() {
    if (null === this.lazyHash_) {
      let e = "";
      this.getPriority().isEmpty() || (e += "priority:" + Hn(this.getPriority().val()) + ":"),
        this.forEachChild(Gn, (t, n) => {
          const i = n.hash();
          "" !== i && (e += ":" + t + ":" + i);
        }),
        (this.lazyHash_ = "" === e ? "" : mt(e));
    }
    return this.lazyHash_;
  }
  getPredecessorChildName(e, t, n) {
    ...
    if (i) {
      const n = i.getPredecessorKey(new Dn(e, t));
  ...
  getFirstChild(e) {
    ...
    return t ? new Dn(t, this.children_.get(t)) : null;
  }
  getLastChildName(e) {
    const t = this.resolveIndex_(e);
    if (t) {
  ...
  getIteratorFrom(e, t) {
    ...
    {
      const n = this.children_.getIteratorFrom(e.name, Dn.Wrap);
      let i = n.peek();
  ...
  getReverseIteratorFrom(e, t) {
    ...
    {
      const n = this.children_.getReverseIteratorFrom(e.name, Dn.Wrap);
      let i = n.peek();
      for (; null != i && t.compare(i, e) > 0; ) n.getNext(), (i = n.peek());
      return n;
    }
  ...
  compareTo(e) {
    return this.isEmpty() ? (e.isEmpty() ? 0 : -1) : e.isLeafNode() || e.isEmpty() ? 1 : e === si ? -1 : 0;
  }
  withIndex(e) {
    if (e === Fn || this.indexMap_.hasIndex(e)) return this;
    {
      const t = this.indexMap_.addIndex(e, this.children_);
      return new ii(this.children_, this.priorityNode_, t);
    }
  }
  isIndexed(e) {
    return e === Fn || this.indexMap_.hasIndex(e);
  }
  equals(e) {
    if (e === this) return !0;
  ...
  resolveIndex_(e) {
    return e === Fn ? null : this.indexMap_.get(e.toString());
  }
}
ii.INTEGER_REGEXP_ = /^(0|[1-9]\d*)$/;
const si = new (class extends ii {
  constructor() {
    super(new Un(jn), ii.EMPTY_NODE, ti.Default);
  }
  compareTo(e) {
    return e === this ? 0 : 1;
  }
  ...
  getImmediateChild(e) {
    return ii.EMPTY_NODE;
  }
  isEmpty() {
    return !1;
  }
})();
Object.defineProperties(Dn, { MIN: { value: new Dn(It, ii.EMPTY_NODE) }, MAX: { value: new Dn(kt, si) } }),
  (Ln.__EMPTY_NODE = ii.EMPTY_NODE),
  (Kn.__childrenNodeConstructor = ii),
  (Bn = si),
  (function (e) {
    Yn = e;
  })(si);
...
function oi(e, t = null) {
  if (null === e) return ii.EMPTY_NODE;
  if (
    ("object" == typeof e && ".priority" in e && (t = e[".priority"]),
    n(null === t || "string" == typeof t || "number" == typeof t || ("object" == typeof t && ".sv" in t), "Invalid priority type found: " + typeof t),
    "object" == typeof e && ".value" in e && null !== e[".value"] && (e = e[".value"]),
    "object" != typeof e || ".sv" in e)
  ) {
    return new Kn(e, oi(t));
  }
  if (e instanceof Array || !ri) {
    let n = ii.EMPTY_NODE;
    return (
      At(e, (t, i) => {
  ...
  }
  {
    ...
    if (
      (At(e, (e, t) => {
        if ("." !== e.substring(0, 1)) {
          const s = oi(t);
          s.isEmpty() || ((i = i || !s.getPriority().isEmpty()), n.push(new Dn(e, s)));
        }
      }),
      0 === n.length)
    )
      return ii.EMPTY_NODE;
    const s = Xn(n, Wn, (e) => e.name, jn);
    if (i) {
      const e = Xn(n, Gn.getCompare());
      return new ii(s, oi(t), new ti({ ".priority": e }, { ".priority": Gn }));
    }
    return new ii(s, oi(t), ti.Default);
  }
}
!(function (e) {
  Vn = e;
...
class ai extends An {
  constructor(e) {
    super(), (this.indexPath_ = e), n(!bn(e) && ".priority" !== _n(e), "Can't create PathIndex with empty path or .priority key");
  }
  extractChild(e) {
  ...
  makePost(e, t) {
    const n = oi(e),
      i = ii.EMPTY_NODE.updateChild(this.indexPath_, n);
    return new Dn(t, i);
  }
  maxPost() {
    const e = ii.EMPTY_NODE.updateChild(this.indexPath_, si);
    return new Dn(kt, e);
  }
  toString() {
    return yn(this.indexPath_, 0).join("/");
  }
}
const hi = new (class extends An {
  compare(e, t) {
    const n = e.node.compareTo(t.node);
    return 0 === n ? xt(e.name, t.name) : n;
  }
  isDefinedOn(e) {
    return !0;
  }
  ...
  updateChild(e, t, i, s, r, o) {
    ...
    return a.getChild(s).equals(i.getChild(s)) && a.isEmpty() === i.isEmpty()
      ...
      : (null != o &&
          (i.isEmpty()
            ? e.hasChild(t)
              ? o.trackChildChange(di(t, a))
              : n(e.isLeafNode(), "A child remove without an old child only makes sense on a leaf node")
            : a.isEmpty()
            ? o.trackChildChange(ci(t, i))
            : o.trackChildChange(ui(t, i, a))),
        e.isLeafNode() && i.isEmpty() ? e : e.updateImmediateChild(t, i).withIndex(this.index_));
  }
  updateFullNode(e, t, n) {
    return (
      null != n &&
        (e.isLeafNode() ||
          e.forEachChild(Gn, (e, i) => {
            t.hasChild(e) || n.trackChildChange(di(e, i));
          }),
        t.isLeafNode() ||
          t.forEachChild(Gn, (t, i) => {
            if (e.hasChild(t)) {
              const s = e.getImmediateChild(t);
              s.equals(i) || n.trackChildChange(ui(t, i, s));
            } else n.trackChildChange(ci(t, i));
          })),
      t.withIndex(this.index_)
    );
  }
  updatePriority(e, t) {
    return e.isEmpty() ? ii.EMPTY_NODE : e.updatePriority(t);
  }
  filtersNodes() {
    return !1;
  }
...
class _i {
  constructor(e) {
    (this.indexedFilter_ = new pi(e.getIndex())),
      (this.index_ = e.getIndex()),
      (this.startPost_ = _i.getStartPost_(e)),
      (this.endPost_ = _i.getEndPost_(e)),
  ...
  updateChild(e, t, n, i, s, r) {
    return this.matches(new Dn(t, n)) || (n = ii.EMPTY_NODE), this.indexedFilter_.updateChild(e, t, n, i, s, r);
  }
  updateFullNode(e, t, n) {
    t.isLeafNode() && (t = ii.EMPTY_NODE);
    let i = t.withIndex(this.index_);
    i = i.updatePriority(ii.EMPTY_NODE);
    const s = this;
    return (
      t.forEachChild(Gn, (e, t) => {
        s.matches(new Dn(e, t)) || (i = i.updateImmediateChild(e, ii.EMPTY_NODE));
      }),
...
class fi {
  ...
  updateChild(e, t, n, i, s, r) {
    return (
      this.rangedFilter_.matches(new Dn(t, n)) || (n = ii.EMPTY_NODE),
      e.getImmediateChild(t).equals(n) ? e : e.numChildren() < this.limit_ ? this.rangedFilter_.getIndexedFilter().updateChild(e, t, n, i, s, r) : this.fullLimitUpdateChild_(e, t, n, s, r)
    );
  }
  updateFullNode(e, t, n) {
    let i;
    if (t.isLeafNode() || t.isEmpty()) i = ii.EMPTY_NODE.withIndex(this.index_);
    else if (2 * this.limit_ < t.numChildren() && t.isIndexed(this.index_)) {
      let e;
      (i = ii.EMPTY_NODE.withIndex(this.index_)), (e = this.reverse_ ? t.getReverseIteratorFrom(this.rangedFilter_.getEndPost(), this.index_) : t.getIteratorFrom(this.rangedFilter_.getStartPost(), this.index_));
      let n = 0;
      ...
      let e;
      (i = t.withIndex(this.index_)), (i = i.updatePriority(ii.EMPTY_NODE)), (e = this.reverse_ ? i.getReverseIterator(this.index_) : i.getIterator(this.index_));
      let n = 0;
      for (; e.hasNext(); ) {
        const t = e.getNext();
        n < this.limit_ && this.withinDirectionalStart(t) && this.withinDirectionalEnd(t) ? n++ : (i = i.updateImmediateChild(t.name, ii.EMPTY_NODE));
      }
    }
  ...
  fullLimitUpdateChild_(e, t, i, s, r) {
    ...
    if (a.hasChild(t)) {
      ...
      if (c && !i.isEmpty() && d >= 0) return null != r && r.trackChildChange(ui(t, i, e)), a.updateImmediateChild(t, i);
      {
        null != r && r.trackChildChange(di(t, e));
        const i = a.updateImmediateChild(t, ii.EMPTY_NODE);
        return null != n && this.rangedFilter_.matches(n) ? (null != r && r.trackChildChange(ci(n.name, n.node)), i.updateImmediateChild(n.name, n.node)) : i;
      }
    }
    return i.isEmpty() ? e : c && o(l, h) >= 0 ? (null != r && (r.trackChildChange(di(l.name, l.node)), r.trackChildChange(ci(t, i))), a.updateImmediateChild(t, i).updateImmediateChild(l.name, ii.EMPTY_NODE)) : e;
  }
}
class mi {
  constructor() {
  ...
  getIndexStartName() {
    return n(this.startSet_, "Only valid if start has been set"), this.startNameSet_ ? this.indexStartName_ : It;
  }
  hasEnd() {
    return this.endSet_;
  }
  ...
  getIndexEndName() {
    return n(this.endSet_, "Only valid if end has been set"), this.endNameSet_ ? this.indexEndName_ : kt;
  }
  hasLimit() {
...
function gi(e) {
  ...
  let i;
  if ((e.index_ === Gn ? (i = "$priority") : e.index_ === hi ? (i = "$value") : e.index_ === Fn ? (i = "$key") : (n(e.index_ instanceof ai, "Unrecognized index type!"), (i = e.index_.toString())), (t.orderBy = S(i)), e.startSet_)) {
    const n = e.startAfterSet_ ? "startAfter" : "startAt";
    (t[n] = S(e.indexStartValue_)), e.startNameSet_ && (t[n] += "," + S(e.indexStartName_));
  }
  if (e.endSet_) {
    const n = e.endBeforeSet_ ? "endBefore" : "endAt";
    (t[n] = S(e.indexEndValue_)), e.endNameSet_ && (t[n] += "," + S(e.indexEndName_));
  }
...
function yi(e) {
  const t = {};
  if (
    (e.startSet_ && ((t.sp = e.indexStartValue_), e.startNameSet_ && (t.sn = e.indexStartName_), (t.sin = !e.startAfterSet_)),
...
class vi extends an {
  constructor(e, t, n, i) {
    super(), (this.repoInfo_ = e), (this.onDataUpdate_ = t), (this.authTokenProvider_ = n), (this.appCheckTokenProvider_ = i), (this.log_ = bt("p:rest:")), (this.listens_ = {});
  }
  reportStats(e) {
  ...
  listen(e, t, n, i) {
    ...
    const r = vi.getListenId_(e, n),
      o = {};
    this.listens_[r] = o;
    const a = gi(e._queryParams);
    this.restRequest_(s + ".json", a, (e, t) => {
      let a = t;
      if ((404 === e && ((a = null), (e = null)), null === e && this.onDataUpdate_(s, a, !1, n), I(this.listens_, r) === o)) {
        let t;
  ...
  unlisten(e, t) {
    const n = vi.getListenId_(e, t);
    delete this.listens_[n];
  }
  get(e) {
    const t = gi(e._queryParams),
      n = e._path.toString(),
      i = new m();
    return (
  ...
  restRequest_(e, t = {}, n) {
    return (
      (t.format = "export"),
      Promise.all([this.authTokenProvider_.getToken(!1), this.appCheckTokenProvider_.getToken(!1)]).then(([i, s]) => {
          ...
          if (n && 4 === o.readyState) {
            ...
            if (o.status >= 200 && o.status < 300) {
              try {
                ...
                Et("Failed to parse JSON response for " + r + ": " + o.responseText);
              }
              n(null, e);
            } else 401 !== o.status && 404 !== o.status && Et("Got unsuccessful REST response for " + r + " Status: " + o.status), n(o.status);
            n = null;
          }
        }),
          o.open("GET", r, !0),
...
function wi(e, t, n) {
  if (bn(t)) (e.value = n), e.children.clear();
  else if (null !== e.value) e.value = e.value.updateChild(t, n);
  else {
    const i = _n(t);
    e.children.has(i) || e.children.set(i, bi());
    wi(e.children.get(i), (t = mn(t)), n);
  }
}
function Si(e, t) {
  if (bn(t)) return (e.value = null), e.children.clear(), !0;
  if (null !== e.value) {
  ...
  if (e.children.size > 0) {
    const n = _n(t);
    if (((t = mn(t)), e.children.has(n))) {
      Si(e.children.get(n), t) && e.children.delete(n);
    }
...
class Ii {
  constructor(e, t) {
    (this.server_ = t), (this.statsToReport_ = {}), (this.statsListener_ = new Ti(e));
    const n = 1e4 + 2e4 * Math.random();
    qt(this.reportStats_.bind(this), Math.floor(n));
  }
  reportStats_() {
    ...
    At(e, (e, i) => {
      ...
      qt(this.reportStats_.bind(this), Math.floor(2 * Math.random() * 3e5));
  }
}
var ki;
function xi(e) {
...
class Ni {
  constructor(e, t, n) {
    (this.path = e), (this.affectedTree = t), (this.revert = n), (this.type = ki.ACK_USER_WRITE), (this.source = { fromUser: !0, fromServer: !1, queryId: null, tagged: !1 });
  }
  operationForChild(e) {
    if (bn(this.path)) {
      ...
      {
        const t = this.affectedTree.subtree(new un(e));
        return new Ni(pn(), t, this.revert);
      }
    }
    return n(_n(this.path) === e, "operationForChild called for unrelated child."), new Ni(mn(this.path), this.affectedTree, this.revert);
  }
}
class Ri {
  constructor(e, t) {
    (this.source = e), (this.path = t), (this.type = ki.LISTEN_COMPLETE);
  }
  operationForChild(e) {
    return bn(this.path) ? new Ri(this.source, pn()) : new Ri(this.source, mn(this.path));
  }
}
class Pi {
  constructor(e, t, n) {
    (this.source = e), (this.path = t), (this.snap = n), (this.type = ki.OVERWRITE);
  }
  operationForChild(e) {
    return bn(this.path) ? new Pi(this.source, pn(), this.snap.getImmediateChild(e)) : new Pi(this.source, mn(this.path), this.snap);
  }
}
class Di {
  constructor(e, t, n) {
    (this.source = e), (this.path = t), (this.children = n), (this.type = ki.MERGE);
  }
  operationForChild(e) {
    if (bn(this.path)) {
      const t = this.children.subtree(new un(e));
      return t.isEmpty() ? null : t.value ? new Pi(this.source, pn(), t.value) : new Di(this.source, pn(), t);
    }
    return n(_n(this.path) === e, "Can't get a merge for a child not on the path of the operation"), new Di(this.source, mn(this.path), this.children);
  }
  toString() {
...
class Ai {
  ...
  isCompleteForPath(e) {
    if (bn(e)) return this.isFullyInitialized() && !this.filtered_;
    const t = _n(e);
...
function Li(e, t, n, s, r, o) {
  ...
  a.sort((t, n) =>
    (function (e, t, n) {
      ...
      const s = new Dn(t.childName, t.snapshotNode),
        r = new Dn(n.childName, n.snapshotNode);
...
function Mi(e, t, n, i) {
  return Fi(new Ai(t, n, i), e.serverCache);
}
function qi(e, t, n, i) {
  return Fi(e.eventCache, new Ai(t, n, i));
}
function Ui(e) {
...
let ji;
class Bi {
  constructor(e, t = (() => (ji || (ji = new Un(Nt)), ji))()) {
  ...
  findRootMostMatchingPathAndValue(e, t) {
    if (null != this.value && t(this.value)) return { path: pn(), value: this.value };
    if (bn(e)) return null;
    {
      const n = _n(e),
        i = this.children.get(n);
      if (null !== i) {
        const s = i.findRootMostMatchingPathAndValue(mn(e), t);
        if (null != s) {
          return { path: Cn(new un(n), s.path), value: s.value };
        }
        return null;
      }
      return null;
  ...
  subtree(e) {
    if (bn(e)) return this;
    {
      ...
      return null !== n ? n.subtree(mn(e)) : new Bi(null);
    }
  }
  set(e, t) {
    if (bn(e)) return new Bi(t, this.children);
    {
      const n = _n(e),
        i = (this.children.get(n) || new Bi(null)).set(mn(e), t),
        s = this.children.insert(n, i);
      return new Bi(this.value, s);
    }
  }
  remove(e) {
    if (bn(e)) return this.children.isEmpty() ? new Bi(null) : new Bi(null, this.children);
    {
      const t = _n(e),
        n = this.children.get(t);
      if (n) {
        const i = n.remove(mn(e));
        let s;
        return (s = i.isEmpty() ? this.children.remove(t) : this.children.insert(t, i)), null === this.value && s.isEmpty() ? new Bi(null) : new Bi(this.value, s);
      }
      return this;
    }
  }
  get(e) {
    if (bn(e)) return this.value;
    {
      const t = _n(e),
        n = this.children.get(t);
      return n ? n.get(mn(e)) : null;
    }
  }
  setTree(e, t) {
    if (bn(e)) return t;
    {
      const n = _n(e),
        i = (this.children.get(n) || new Bi(null)).setTree(mn(e), t);
      let s;
      return (s = i.isEmpty() ? this.children.remove(n) : this.children.insert(n, i)), new Bi(this.value, s);
    }
  }
  fold(e) {
    return this.fold_(pn(), e);
  }
  fold_(e, t) {
    const n = {};
    return (
      this.children.inorderTraversal((i, s) => {
        n[i] = s.fold_(Cn(e, i), t);
      }),
      t(e, this.value, n)
    );
  }
  findOnPath(e, t) {
    return this.findOnPath_(e, pn(), t);
  }
  findOnPath_(e, t, n) {
    ...
    if (bn(e)) return null;
    {
      ...
      return s ? s.findOnPath_(mn(e), Cn(t, i), n) : null;
    }
  }
  foreachOnPath(e, t) {
    return this.foreachOnPath_(e, pn(), t);
  }
  foreachOnPath_(e, t, n) {
    if (bn(e)) return this;
    {
      ...
      const i = _n(e),
        s = this.children.get(i);
      return s ? s.foreachOnPath_(mn(e), Cn(t, i), n) : new Bi(null);
    }
  }
  foreach(e) {
    this.foreach_(pn(), e);
...
class Hi {
  ...
  static empty() {
    return new Hi(new Bi(null));
  }
}
function zi(e, t, n) {
  if (bn(t)) return new Hi(new Bi(n));
  {
    ...
    if (null != i) {
      ...
      let r = i.value;
      const o = wn(s, t);
      return (r = r.updateChild(o, n)), new Hi(e.writeTree_.set(s, r));
    }
    {
      const i = new Bi(n),
...
function Vi(e, t) {
  if (bn(t)) return Hi.empty();
  {
    const n = e.writeTree_.setTree(t, new Bi(null));
    return new Hi(n);
  }
}
function Yi(e, t) {
...
function Ki(e, t) {
  ...
  return null != n ? e.writeTree_.get(n.path).getChild(wn(n.path, t)) : null;
}
function Gi(e) {
  const t = [],
  ...
  return (
    null != n
      ? n.isLeafNode() ||
        n.forEachChild(Gn, (e, n) => {
          t.push(new Dn(e, n));
        })
      : e.writeTree_.children.inorderTraversal((e, n) => {
          null != n.value && t.push(new Dn(e, n.value));
        }),
    t
  );
}
function Qi(e, t) {
  ...
  {
    const n = Ki(e, t);
    return new Hi(null != n ? new Bi(n) : e.writeTree_.subtree(t));
  }
}
function Ji(e) {
  ...
  if (null != t.value) return i.updateChild(e, t.value);
  {
    ...
    return (
      t.children.inorderTraversal((t, r) => {
        ".priority" === t ? (n(null !== r.value, "Priority writes must always be leaf nodes"), (s = r.value)) : (i = Zi(Cn(e, t), r, i));
      }),
      i.getChild(e).isEmpty() || null === s || (i = i.updateChild(Cn(e, ".priority"), s)),
      i
    );
  }
}
...
function ts(e, t) {
  ...
  for (; r && a >= 0; ) {
    ...
    t.visible && (a >= i && ns(t, s.path) ? (r = !1) : Tn(s.path, t.path) && (o = !0)), a--;
  }
  if (r) {
    if (o)
      return (
        (function (e) {
          (e.visibleWrites = ss(e.allWrites, is, pn())), e.allWrites.length > 0 ? (e.lastWriteId = e.allWrites[e.allWrites.length - 1].writeId) : (e.lastWriteId = -1);
        })(e),
        !0
      );
    if (s.snap) e.visibleWrites = Vi(e.visibleWrites, s.path);
      ...
      At(s.children, (t) => {
        e.visibleWrites = Vi(e.visibleWrites, Cn(s.path, t));
      });
    }
    return !0;
  }
...
function ns(e, t) {
  ...
  for (const n in e.children) if (e.children.hasOwnProperty(n) && Tn(Cn(e.path, n), t)) return !0;
  return !1;
}
function is(e) {
  return e.visible;
...
function ss(e, t, n) {
  ...
  for (let r = 0; r < e.length; ++r) {
    ...
    if (t(o)) {
      const e = o.path;
      let t;
      if (o.snap) Tn(n, e) ? ((t = wn(n, e)), (s = zi(s, t, o.snap))) : Tn(e, n) && ((t = wn(e, n)), (s = zi(s, pn(), o.snap.getChild(t))));
      else {
        if (!o.children) throw i("WriteRecord should have .snap or .children");
        if (Tn(n, e)) (t = wn(n, e)), (s = $i(s, t, o.children));
        else if (Tn(e, n))
          if (((t = wn(e, n)), bn(t))) s = $i(s, pn(), o.children);
          else {
            const e = I(o.children, _n(t));
            if (e) {
              const n = e.getChild(mn(t));
              s = zi(s, pn(), n);
            }
          }
      }
...
function rs(e, t, n, i, s) {
  if (i || s) {
    const r = Qi(e.visibleWrites, t);
    if (!s && Ji(r)) return n;
    if (s || null != n || Yi(r, pn())) {
      const r = (e) => (e.visible || s) && (!i || !~i.indexOf(e.writeId)) && (Tn(e.path, t) || Tn(t, e.path));
      return Xi(ss(e.allWrites, r, t), n || ii.EMPTY_NODE);
    }
    return null;
  }
  {
    const i = Ki(e.visibleWrites, t);
    if (null != i) return i;
    {
      const i = Qi(e.visibleWrites, t);
      if (Ji(i)) return n;
      if (null != n || Yi(i, pn())) {
        return Xi(i, n || ii.EMPTY_NODE);
      }
      return null;
    }
  }
...
function os(e, t, n, i) {
  return rs(e.writeTree, e.treePath, t, n, i);
}
function as(e, t) {
  return (function (e, t, n) {
    let i = ii.EMPTY_NODE;
    const s = Ki(e.visibleWrites, t);
    if (s)
      return (
        s.isLeafNode() ||
          s.forEachChild(Gn, (e, t) => {
            i = i.updateImmediateChild(e, t);
          }),
        i
      );
    if (n) {
      const s = Qi(e.visibleWrites, t);
      return (
        n.forEachChild(Gn, (e, t) => {
          const n = Xi(Qi(s, new un(e)), t);
    ...
    return (
      Gi(Qi(e.visibleWrites, t)).forEach((e) => {
        i = i.updateImmediateChild(e.name, e.node);
      }),
      i
    );
...
function hs(e, t, i, s) {
  return (function (e, t, i, s, r) {
    ...
    const o = Cn(t, i);
    if (Yi(e.visibleWrites, o)) return null;
    {
      const t = Qi(e.visibleWrites, o);
      return Ji(t) ? r.getChild(i) : Xi(t, r.getChild(i));
    }
  })(e.writeTree, e.treePath, t, i, s);
}
function ls(e, t) {
  return (function (e, t) {
    return Ki(e.visibleWrites, t);
  })(e.writeTree, Cn(e.treePath, t));
}
function cs(e, t, n, i, s, r) {
  return (function (e, t, n, i, s, r, o) {
    let a;
    const h = Qi(e.visibleWrites, t),
      l = Ki(h, pn());
    if (null != l) a = l;
    else {
      if (null == n) return [];
...
function ds(e, t, n) {
  return (function (e, t, n, i) {
    const s = Cn(t, n),
      r = Ki(e.visibleWrites, s);
    if (null != r) return r;
    if (i.isCompleteForChild(n)) return Xi(Qi(e.visibleWrites, s), i.getNode().getImmediateChild(n));
    return null;
  })(e.writeTree, e.treePath, t, n);
}
function us(e, t) {
  return ps(Cn(e.treePath, t), e.writeTree);
}
function ps(e, t) {
...
class _s {
  ...
  trackChildChange(e) {
    ...
    if (r) {
      const n = r.type;
      if ("child_added" === t && "child_removed" === n) this.changeMap.set(s, ui(s, e.snapshotNode, r.snapshotNode));
      else if ("child_removed" === t && "child_added" === n) this.changeMap.delete(s);
      else if ("child_removed" === t && "child_changed" === n) this.changeMap.set(s, di(s, r.oldSnap));
      else if ("child_changed" === t && "child_added" === n) this.changeMap.set(s, ci(s, e.snapshotNode));
      else {
        if ("child_changed" !== t || "child_changed" !== n) throw i("Illegal combination of changes: " + e + " occurred after " + r);
        this.changeMap.set(s, ui(s, e.snapshotNode, r.oldSnap));
      }
...
class ms {
  ...
  getCompleteChild(e) {
    ...
    {
      const t = null != this.optCompleteServerCache_ ? new Ai(this.optCompleteServerCache_, !0, !1) : this.viewCache_.serverCache;
      return ds(this.writes_, e, t);
    }
  }
  getChildAfterChild(e, t, n) {
    const i = null != this.optCompleteServerCache_ ? this.optCompleteServerCache_ : Wi(this.viewCache_),
      s = cs(this.writes_, i, t, 1, n, e);
    return 0 === s.length ? null : s[0];
  }
}
function gs(e, t, s, r, o) {
  const a = new _s();
  let h, l;
  if (s.type === ki.OVERWRITE) {
    const i = s;
    i.source.fromUser ? (h = Cs(e, t, i.path, i.snap, r, o, a)) : (n(i.source.fromServer, "Unknown source."), (l = i.source.tagged || (t.serverCache.isFiltered() && !bn(i.path))), (h = vs(e, t, i.path, i.snap, r, o, l, a)));
  } else if (s.type === ki.MERGE) {
    const i = s;
    i.source.fromUser
      ? (h = (function (e, t, n, i, s, r, o) {
        ...
        })(e, t, i.path, i.children, r, o, a))
      : (n(i.source.fromServer, "Unknown source."), (l = i.source.tagged || t.serverCache.isFiltered()), (h = Ss(e, t, i.path, i.children, r, o, l, a)));
  } else if (s.type === ki.ACK_USER_WRITE) {
    const i = s;
    h = i.revert
      ? (function (e, t, i, s, r, o) {
          let a;
          if (null != ls(s, i)) return t;
          {
            const h = new ms(s, t, r),
              l = t.eventCache.getNode();
            let c;
            if (bn(i) || ".priority" === _n(i)) {
              let i;
              if (t.serverCache.isFullyInitialized()) i = os(s, Wi(t));
              else {
                const e = t.serverCache.getNode();
                n(e instanceof ii, "serverChildren would be complete if leaf node"), (i = as(s, e));
              }
              c = e.filter.updateFullNode(l, i, o);
            } else {
              const n = _n(i);
              let r = ds(s, n, t.serverCache);
              null == r && t.serverCache.isCompleteForChild(n) && (r = l.getImmediateChild(n)),
                (c = null != r ? e.filter.updateChild(l, n, r, mn(i), h, o) : t.eventCache.getNode().hasChild(n) ? e.filter.updateChild(l, n, ii.EMPTY_NODE, mn(i), h, o) : l),
                c.isEmpty() && t.serverCache.isFullyInitialized() && ((a = os(s, Wi(t))), a.isLeafNode() && (c = e.filter.updateFullNode(c, a, o)));
            }
            return (a = t.serverCache.isFullyInitialized() || null != ls(s, pn())), Mi(t, c, a, e.filter.filtersNodes());
          }
        })(e, t, i.path, r, o, a)
      : (function (e, t, n, i, s, r, o) {
          if (null != ls(s, n)) return t;
          const a = t.serverCache.isFiltered(),
            h = t.serverCache;
          if (null != i.value) {
            if ((bn(n) && h.isFullyInitialized()) || h.isCompleteForPath(n)) return vs(e, t, n, h.getNode().getChild(n), s, r, a, o);
            if (bn(n)) {
              let i = new Bi(null);
              return (
                h.getNode().forEachChild(Fn, (e, t) => {
                  i = i.set(new un(e), t);
                }),
                Ss(e, t, n, i, s, r, a, o)
              );
    ...
    if (s.type !== ki.LISTEN_COMPLETE) throw i("Unknown operation type: " + s.type);
    h = (function (e, t, n, i, s) {
      const r = t.serverCache,
        o = qi(t, r.getNode(), r.isFullyInitialized() || bn(n), r.isFiltered());
      return ys(e, o, n, i, fs, s);
    })(e, t, s.path, r, a);
  }
    ...
    (function (e, t, n) {
      ...
      if (i.isFullyInitialized()) {
        const s = i.getNode().isLeafNode() || i.getNode().isEmpty(),
          r = Ui(e);
        (n.length > 0 || !e.eventCache.isFullyInitialized() || (s && !i.getNode().equals(r)) || !i.getNode().getPriority().equals(r.getPriority())) && n.push(li(Ui(t)));
      }
    })(t, h, c),
    { viewCache: h, changes: c }
  );
}
function ys(e, t, i, s, r, o) {
  ...
  if (null != ls(s, i)) return t;
  {
    ...
    if (bn(i))
      if ((n(t.serverCache.isFullyInitialized(), "If change path is empty, we must have complete server data"), t.serverCache.isFiltered())) {
        const n = Wi(t),
          i = as(s, n instanceof ii ? n : ii.EMPTY_NODE);
      ...
      const c = _n(i);
      if (".priority" === c) {
        n(1 === fn(i), "Can't have a priority with additional path components");
        const r = a.getNode();
        ...
        if (a.isCompleteForChild(c)) {
          l = t.serverCache.getNode();
          const e = hs(s, i, a.getNode(), l);
          d = null != e ? a.getNode().getImmediateChild(c).updateChild(n, e) : a.getNode().getImmediateChild(c);
        } else d = ds(s, c, t.serverCache);
        h = null != d ? e.filter.updateChild(a.getNode(), c, d, n, r, o) : a.getNode();
      }
    }
    return Mi(t, h, a.isFullyInitialized() || bn(i), e.filter.filtersNodes());
  }
}
function vs(e, t, n, i, s, r, o, a) {
  const h = t.serverCache;
  let l;
  const c = o ? e.filter : e.filter.getIndexedFilter();
  if (bn(n)) l = c.updateFullNode(h.getNode(), i, null);
  else if (c.filtersNodes() && !h.isFiltered()) {
    const e = h.getNode().updateChild(n, i);
    l = c.updateFullNode(h.getNode(), e, null);
  } else {
    const e = _n(n);
    if (!h.isCompleteForPath(n) && fn(n) > 1) return t;
    const s = mn(n),
      r = h.getNode().getImmediateChild(e).updateChild(s, i);
    l = ".priority" === e ? c.updatePriority(h.getNode(), r) : c.updateChild(h.getNode(), e, r, s, fs, null);
  }
  const d = qi(t, l, h.isFullyInitialized() || bn(n), c.filtersNodes());
  return ys(e, d, n, s, new ms(s, d, r), a);
}
function Cs(e, t, n, i, s, r, o) {
  const a = t.eventCache;
  let h, l;
  const c = new ms(s, t, r);
  if (bn(n)) (l = e.filter.updateFullNode(t.eventCache.getNode(), i, o)), (h = Mi(t, l, !0, e.filter.filtersNodes()));
  else {
    const s = _n(n);
    if (".priority" === s) (l = e.filter.updatePriority(t.eventCache.getNode(), i)), (h = Mi(t, l, a.isFullyInitialized(), a.isFiltered()));
    else {
      const r = mn(n),
      ...
      if (bn(r)) d = i;
        ...
        d = null != e ? (".priority" === gn(r) && e.getChild(vn(r)).isEmpty() ? e : e.updateChild(r, i)) : ii.EMPTY_NODE;
      }
      if (l.equals(d)) h = t;
      else {
        h = Mi(t, e.filter.updateChild(a.getNode(), s, d, r, c, o), a.isFullyInitialized(), e.filter.filtersNodes());
      }
    }
  }
  return h;
...
function Ss(e, t, n, i, s, r, o, a) {
  if (t.serverCache.getNode().isEmpty() && !t.serverCache.isFullyInitialized()) return t;
  let h,
    l = t;
  h = bn(n) ? i : new Bi(null).setTree(n, i);
  const c = t.serverCache.getNode();
  return (
    h.children.inorderTraversal((n, i) => {
      if (c.hasChild(n)) {
        const h = ws(0, t.serverCache.getNode().getImmediateChild(n), i);
        l = vs(e, l, new un(n), h, s, r, o, a);
      }
    }),
    h.children.inorderTraversal((n, i) => {
...
class Es {
  constructor(e, t) {
    ...
    const n = this.query_._queryParams,
      i = new pi(n.getIndex()),
      s = (r = n).loadsAllData() ? new pi(r.getIndex()) : r.hasLimit() ? new fi(r) : new _i(r);
    var r;
    ...
    const o = t.serverCache,
      a = t.eventCache,
      h = i.updateFullNode(ii.EMPTY_NODE, o.getNode(), null),
      l = s.updateFullNode(ii.EMPTY_NODE, a.getNode(), null),
      c = new Ai(h, o.isFullyInitialized(), i.filtersNodes()),
      d = new Ai(l, a.isFullyInitialized(), s.filtersNodes());
    (this.viewCache_ = Fi(d, c)), (this.eventGenerator_ = new Oi(this.query_));
  }
  get query() {
    return this.query_;
  }
...
function Ts(e, t) {
  const n = Wi(e.viewCache_);
  return n && (e.query._queryParams.loadsAllData() || (!bn(t) && !n.getImmediateChild(_n(t)).isEmpty())) ? n.getChild(t) : null;
}
function Is(e) {
...
function xs(e, t, i, s) {
  t.type === ki.MERGE && null !== t.source.queryId && (n(Wi(e.viewCache_), "We should always have a full cache before handling merges"), n(Ui(e.viewCache_), "Missing event cache, even though we have a server cache"));
  const r = e.viewCache_,
    o = gs(e.processor_, r, t, i, s);
  var a, h;
  return (
    (a = e.processor_),
    (h = o.viewCache),
    n(h.eventCache.getNode().isIndexed(a.filter.getIndex()), "Event snap not indexed"),
    n(h.serverCache.getNode().isIndexed(a.filter.getIndex()), "Server snap not indexed"),
    n(o.viewCache.serverCache.isFullyInitialized() || !r.serverCache.isFullyInitialized(), "Once a server snap is complete, it should never go back"),
    (e.viewCache_ = o.viewCache),
    Ns(e, o.changes, o.viewCache.eventCache.getNode(), null)
  );
}
function Ns(e, t, n, i) {
  ...
  return (function (e, t, n, i) {
    ...
    return (
      t.forEach((t) => {
        var n;
        "child_changed" === t.type && e.index_.indexedValueChanged(t.oldSnap, t.snapshotNode) && r.push(((n = t.childName), { type: "child_moved", snapshotNode: t.snapshotNode, childName: n }));
      }),
      Li(e, s, "child_removed", t, i, n),
      Li(e, s, "child_added", t, i, n),
      Li(e, s, "child_moved", r, i, n),
      Li(e, s, "child_changed", t, i, n),
      Li(e, s, "value", t, i, n),
      s
    );
...
function As(e, t, i, s) {
  ...
  if (null !== r) {
    ...
    return n(null != o, "SyncTree gave us an op for an invalid query."), xs(o, t, i, s);
  }
  {
    let n = [];
    for (const r of e.views.values()) n = n.concat(xs(r, t, i, s));
    return n;
  }
}
function Os(e, t, n, i, s, r) {
  const o = (function (e, t, n, i, s) {
    ...
    if (!o) {
      let e = os(n, s ? i : null),
        r = !1;
      e ? (r = !0) : i instanceof ii ? ((e = as(n, i)), (r = !1)) : ((e = ii.EMPTY_NODE), (r = !1));
      const o = Fi(new Ai(e, r, !1), new Ai(i, s, !1));
      return new Es(t, o);
    }
    return o;
  })(e, t, i, s, r);
  return (
    ...
    (function (e, t) {
      ...
      n.getNode().isLeafNode() ||
        n.getNode().forEachChild(Gn, (e, t) => {
          i.push(ci(e, t));
        });
      return n.isFullyInitialized() && i.push(li(n.getNode())), Ns(e, i, n.getNode(), t);
    })(o, n)
  );
}
function Ls(e, t, i, s) {
  ...
  let a = [];
  const h = Ws(e);
  if ("default" === r) for (const [t, n] of e.views.entries()) (a = a.concat(ks(n, i, s))), Is(n) && (e.views.delete(t), n.query._queryParams.loadsAllData() || o.push(n.query));
  else {
    const t = e.views.get(r);
    t && ((a = a.concat(ks(t, i, s))), Is(t) && (e.views.delete(r), t.query._queryParams.loadsAllData() || o.push(t.query)));
  }
  return h && !Ws(e) && o.push(new (n(Rs, "Reference.ts has not been loaded"), Rs)(t._repo, t._path)), { removed: o, events: a };
}
function Fs(e) {
  const t = [];
...
function Ms(e, t) {
  let n = null;
  for (const i of e.views.values()) n = n || Ts(i, t);
  return n;
}
function qs(e, t) {
  if (t._queryParams.loadsAllData()) return js(e);
  {
...
class Hs {
  constructor(e) {
    (this.listenProvider_ = e), (this.syncPointTree_ = new Bi(null)), (this.pendingWriteTree_ = { visibleWrites: Hi.empty(), allWrites: [], lastWriteId: -1 }), (this.tagToQueryMap = new Map()), (this.queryToTagMap = new Map());
  }
}
function zs(e, t, i, s, r) {
  return (
    (function (e, t, i, s, r) {
      n(s > e.lastWriteId, "Stacking an older write on top of newer ones"), void 0 === r && (r = !0), e.allWrites.push({ path: t, snap: i, writeId: s, visible: r }), r && (e.visibleWrites = zi(e.visibleWrites, t, i)), (e.lastWriteId = s);
    })(e.pendingWriteTree_, t, i, s, r),
    r ? Qs(e, new Pi({ fromUser: !0, fromServer: !1, queryId: null, tagged: !1 }, t, i)) : []
  );
}
function $s(e, t, n = !1) {
  ...
  if (ts(e.pendingWriteTree_, t)) {
    ...
    return (
      ...
      Qs(e, new Ni(i.path, t, n))
    );
  }
  return [];
}
function Vs(e, t, n) {
  return Qs(e, new Pi({ fromUser: !1, fromServer: !0, queryId: null, tagged: !1 }, t, n));
}
function Ys(e, t, n, i, s = !1) {
  const r = t._path,
        ...
        if (!t.isEmpty()) {
          ...
          for (let t = 0; t < n.length; ++t) {
            const i = n[t],
              s = i.query,
              r = Zs(e, i);
            e.listenProvider_.startListening(rr(s), er(e, s), r.hashFn, r.onComplete);
          }
        }
      }
      if (!s && l.length > 0 && !i)
        if (n) {
          const n = null;
          e.listenProvider_.stopListening(rr(t), n);
        } else
          l.forEach((t) => {
            const n = e.queryToTagMap.get(tr(t));
            e.listenProvider_.stopListening(rr(t), n);
          });
    }
    !(function (e, t) {
...
function Ks(e, t, i, s = !1) {
  ...
  let h,
    l = e.syncPointTree_.get(r);
  if ((l ? ((a = a || Ws(l)), (o = o || Ms(l, pn()))) : ((l = new Ds()), (e.syncPointTree_ = e.syncPointTree_.set(r, l))), null != o)) h = !0;
  else {
    (h = !1), (o = ii.EMPTY_NODE);
  ...
  let d = Os(l, t, i, es(e.pendingWriteTree_, r), o, h);
  if (!c && !a && !s) {
    const i = qs(l, t);
    d = d.concat(
      (function (e, t, i) {
        const s = t._path,
          r = er(e, t),
          o = Zs(e, i),
          a = e.listenProvider_.startListening(rr(t), r, o.hashFn, o.onComplete),
          h = e.syncPointTree_.subtree(s);
        if (r) n(!Ws(h.value), "If we're adding a query, it shouldn't be shadowed");
        else {
          const t = h.fold((e, t, n) => {
            if (!bn(e) && t && Ws(t)) return [js(t).query];
            {
              let e = [];
              return (
                t && (e = e.concat(Fs(t).map((e) => e.query))),
                At(n, (t, n) => {
                  e = e.concat(n);
                }),
                e
          ...
          for (let n = 0; n < t.length; ++n) {
            const i = t[n];
            e.listenProvider_.stopListening(rr(i), er(e, i));
          }
        }
        return a;
      })(e, t, i)
...
function Qs(e, t) {
  return Js(t, e.syncPointTree_, null, es(e.pendingWriteTree_, pn()));
}
function Js(e, t, n, i) {
  if (bn(e.path)) return Xs(e, t, n, i);
  {
    const s = t.get(pn());
    null == n && null != s && (n = Ms(s, pn()));
    let r = [];
    const o = _n(e.path),
    ...
    if (h && a) {
      const e = n ? n.getImmediateChild(o) : null,
        t = us(i, o);
      r = r.concat(Js(a, h, e, t));
    }
    return s && (r = r.concat(As(s, e, i, n))), r;
  }
}
function Xs(e, t, n, i) {
  const s = t.get(pn());
  ...
  return (
    t.children.inorderTraversal((t, s) => {
      ...
      h && (r = r.concat(Xs(h, s, o, a)));
    }),
    s && (r = r.concat(As(s, e, i, n))),
    r
  );
}
function Zs(e, t) {
          ...
          ? (function (e, t, n) {
              ...
              if (i) {
                const n = ir(i),
                  ...
                  r = n.queryId,
                  o = wn(s, t);
                return sr(e, s, new Ri(xi(r), o));
              }
              return [];
            })(e, n._path, i)
          : (function (e, t) {
              return Qs(e, new Ri({ fromUser: !1, fromServer: !0, queryId: null, tagged: !1 }, t));
            })(e, n._path);
      {
        const i = (function (e, t) {
          let n = "Unknown Error";
...
function ir(e) {
  const t = e.indexOf("$");
  return n(-1 !== t && t < e.length - 1, "Bad queryKey."), { queryId: e.substr(t + 1), path: new un(e.substr(0, t)) };
}
function sr(e, t, i) {
  const s = e.syncPointTree_.get(t);
  n(s, "Missing sync point for query tag that we're tracking");
  return As(s, i, es(e.pendingWriteTree_, t), null);
}
function rr(e) {
  return e._queryParams.loadsAllData() && !e._queryParams.isDefault() ? new (n(Ps, "Reference.ts has not been loaded"), Ps)(e._repo, e._path) : e;
}
class or {
  constructor(e) {
    this.node_ = e;
...
class ar {
  ...
  getImmediateChild(e) {
    const t = Cn(this.path_, e);
    return new ar(this.syncTree_, t);
  }
  node() {
    return Gs(this.syncTree_, this.path_);
  }
}
const hr = (e) => (((e = e || {}).timestamp = e.timestamp || new Date().getTime()), e),
  lr = (e, t, i) =>
    e && "object" == typeof e
      ? (n(".sv" in e, "Unexpected leaf node or priority contents"), "string" == typeof e[".sv"] ? cr(e[".sv"], t, i) : "object" == typeof e[".sv"] ? dr(e[".sv"], t) : void n(!1, "Unexpected server value: " + JSON.stringify(e, null, 2)))
      : e,
  cr = (e, t, i) => {
  ...
  ur = (e, t, n, i) => _r(t, new ar(n, e), i),
  pr = (e, t, n) => _r(e, new or(t), n);
function _r(e, t, n) {
  const i = e.getPriority().val(),
    s = lr(i, t.getImmediateChild(".priority"), n);
  let r;
  if (e.isLeafNode()) {
    const i = e,
      r = lr(i.getValue(), t, n);
    return r !== i.getValue() || s !== i.getPriority().val() ? new Kn(r, oi(s)) : e;
  }
  {
    const i = e;
    return (
      (r = i),
      s !== i.getPriority().val() && (r = r.updatePriority(new Kn(s))),
      i.forEachChild(Gn, (e, i) => {
        const s = _r(i, t.getImmediateChild(e), n);
...
function mr(e, t) {
  let n = t instanceof un ? t : new un(t),
    i = e,
    s = _n(n);
  for (; null !== s; ) {
    const e = I(i.node.children, s) || { children: {}, childCount: 0 };
    (i = new fr(s, i, e)), (n = mn(n)), (s = _n(n));
  }
  return i;
}
function gr(e) {
...
function wr(e) {
  return new un(null === e.parent ? e.name : wr(e.parent) + "/" + e.name);
}
function Sr(e) {
  null !== e.parent &&
    (function (e, t, n) {
      const i = (function (e) {
          return void 0 === gr(e) && !vr(e);
        })(n),
        s = T(e.node.children, t);
      i && s ? (delete e.node.children[t], e.node.childCount--, Sr(e)) : i || s || ((e.node.children[t] = n.node), e.node.childCount++, Sr(e));
    })(e.parent, e.name, e);
}
const Er = /[\[\].#$\/\u0000-\u001F\u007F]/,
  Tr = /[\[\].#$\u0000-\u001F\u007F]/,
  Ir = 10485760,
  kr = (e) => "string" == typeof e && 0 !== e.length && !Er.test(e),
  xr = (e) => "string" == typeof e && 0 !== e.length && !Tr.test(e),
  Nr = (e) => null === e || "string" == typeof e || ("number" == typeof e && !Tt(e)) || (e && "object" == typeof e && T(e, ".sv")),
  Rr = (e, t, n, i) => {
    (i && void 0 === t) || Pr(D(e, "value"), t, n);
  },
  Pr = (e, t, n) => {
    const i = n instanceof un ? new In(n, e) : n;
    if (void 0 === t) throw Error(e + "contains undefined " + xn(i));
    if ("function" == typeof t) throw Error(e + "contains a function " + xn(i) + " with contents = " + t.toString());
    if (Tt(t)) throw Error(e + "contains " + t.toString() + " " + xn(i));
    if ("string" == typeof t && t.length > Ir / 3 && A(t) > Ir) throw Error(e + "contains a string greater than " + Ir + " utf8 bytes " + xn(i) + " ('" + t.substring(0, 50) + "...')");
    if (t && "object" == typeof t) {
      ...
      if (
        (At(t, (t, r) => {
          if (".value" === t) n = !0;
          else if (".priority" !== t && ".sv" !== t && ((s = !0), !kr(t))) throw Error(e + " contains an invalid key (" + t + ") " + xn(i) + '.  Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
          !(function (e, t) {
            e.parts_.length > 0 && (e.byteLength_ += 1), e.parts_.push(t), (e.byteLength_ += A(t)), kn(e);
          })(i, t),
            Pr(e, r, i),
            (function (e) {
        ...
        throw Error(e + ' contains ".value" child ' + xn(i) + " in addition to actual children.");
    }
  },
  Dr = (e, t, n) => {
    if (!xr(n)) throw Error(D(e, t) + 'was an invalid path = "' + n + '". Paths must be non-empty strings and can\'t contain ".", "#", "$", "[", or "]"');
  },
  Ar = (e, t, n) => {
    n && (n = n.replace(/^\/*\.info(\/|$)/, "/")), Dr(e, t, n);
  },
  Or = (e, t) => {
    if (".info" === _n(t)) throw Error(e + " failed = Can't modify data under /.info/");
  },
  Lr = (e, t) => {
    ...
    if (
      ...
      (!kr(t.repoInfo.namespace) && "localhost" !== t.repoInfo.host.split(":")[0]) ||
      (0 !== n.length && !((e) => (e && (e = e.replace(/^\/*\.info(\/|$)/, "/")), xr(e)))(n))
    )
      throw Error(D(e, "url") + 'must be a valid firebase URL and the path can\'t contain ".", "#", "$", "[", or "]".');
  };
class Fr {
  constructor() {
...
function Mr(e, t) {
  ...
  for (let i = 0; i < t.length; i++) {
    const s = t[i],
      r = s.getPath();
    null === n || En(r, n.path) || (e.eventLists_.push(n), (n = null)), null === n && (n = { events: [], path: r }), n.events.push(s);
  }
  n && e.eventLists_.push(n);
}
function qr(e, t, n) {
  Mr(e, n), Wr(e, (e) => En(e, t));
}
function Ur(e, t, n) {
  Mr(e, n), Wr(e, (e) => Tn(e, t) || Tn(t, e));
}
function Wr(e, t) {
  e.recursionDepth_++;
  let n = !0;
  for (let i = 0; i < e.eventLists_.length; i++) {
    ...
    if (s) {
      t(s.path) ? (jr(e.eventLists_[i]), (e.eventLists_[i] = null)) : (n = !1);
    }
  }
...
function jr(e) {
  for (let t = 0; t < e.events.length; t++) {
    ...
    if (null !== n) {
      ...
      yt && Ct("event: " + n.toString()), Mt(i);
    }
  }
}
const Br = "repo_interrupt",
  Hr = 25;
class zr {
  constructor(e, t, n, i) {
    (this.repoInfo_ = e),
      ...
      (this.onDisconnect_ = bi()),
      (this.transactionQueueTree_ = new fr()),
...
function $r(e, t, n) {
  if (
    ...
    (e.persistentConnection_ = new Pn(
      e.repoInfo_,
      t,
      (t, n, i, s) => {
        Kr(e, t, n, i, s);
  ...
  e.authTokenProvider_.addTokenChangeListener((t) => {
    ...
    (e.statsReporter_ = (function (e, t) {
      const n = e.toString();
      return Qt[n] || (Qt[n] = t()), Qt[n];
    })(e.repoInfo_, () => new Ii(e.stats_, e.server_))),
    (e.infoData_ = new Ci()),
    (e.infoSyncTree_ = new Hs({
      startListening(t, n, i, s) {
        let r = [];
        const o = e.infoData_.getNode(t._path);
        return (
          o.isEmpty() ||
            ((r = Vs(e.infoSyncTree_, t._path, o)),
            setTimeout(() => {
              s("ok");
            }, 0)),
          r
...
function Vr(e) {
  const t = e.infoData_.getNode(new un(".info/serverTimeOffset")).val() || 0;
  return new Date().getTime() + t;
}
function Yr(e) {
  return hr({ timestamp: Vr(e) });
}
function Kr(e, t, n, i, s) {
  ...
  if (s)
    ...
    const t = x(n, (e) => oi(e));
    o = (function (e, t, n) {
      const i = Bi.fromObject(n);
      return Qs(e, new Di({ fromUser: !1, fromServer: !0, queryId: null, tagged: !1 }, t, i));
  ...
  let a = r;
  o.length > 0 && (a = ro(e, r)), Ur(e.eventQueue_, a, o);
}
function Gr(e, t) {
  Qr(e, "connected", t),
    !1 === t &&
      (function (e) {
        to(e, "onDisconnectEvents");
        const t = Yr(e),
          n = bi();
        Ei(e.onDisconnect_, pn(), (i, s) => {
          const r = ur(i, s, e.serverSyncTree_, t);
          wi(n, i, r);
        });
        let i = [];
        Ei(n, pn(), (t, n) => {
          ...
          (e.onDisconnect_ = bi()),
          Ur(e.eventQueue_, pn(), i);
      })(e);
}
function Qr(e, t, n) {
  const i = new un("/.info/" + t),
    s = oi(n);
...
function Xr(e, t, n) {
  e.server_.onDisconnectCancel(t.toString(), (i, s) => {
    "ok" === i && Si(e.onDisconnect_, t), no(e, n, i, s);
  });
}
function Zr(e, t, n, i) {
  const s = oi(n);
  e.server_.onDisconnectPut(t.toString(), s.val(!0), (n, r) => {
    "ok" === n && wi(e.onDisconnect_, t, s), no(e, i, n, r);
  });
}
function eo(e, t, n) {
  let i;
  (i = ".info" === _n(t._path) ? Ys(e.infoSyncTree_, t, n) : Ys(e.serverSyncTree_, t, n)), qr(e.eventQueue_, t._path, i);
}
function to(e, ...t) {
  let n = "";
  e.persistentConnection_ && (n = e.persistentConnection_.id + ":"), Ct(n, ...t);
}
function no(e, t, n, i) {
  t &&
    Mt(() => {
...
function io(e, t, n) {
  return Gs(e.serverSyncTree_, t, n) || ii.EMPTY_NODE;
}
function so(e, t = e.transactionQueueTree_) {
  if ((t || lo(e, t), gr(t))) {
    const i = ao(e, t);
    ...
    i.every((e) => 0 === e.status) &&
      (function (e, t, i) {
        ...
        e.server_.put(
          ...
          h,
          (n) => {
            to(e, "transaction put response", { path: l.toString(), status: n });
            let s = [];
            if ("ok" === n) {
              const n = [];
              for (let t = 0; t < i.length; t++)
                (i[t].status = 2), (s = s.concat($s(e.serverSyncTree_, i[t].currentWriteId))), i[t].onComplete && n.push(() => i[t].onComplete(null, !0, i[t].currentOutputSnapshotResolved)), i[t].unwatcher();
              lo(e, mr(e.transactionQueueTree_, t)), so(e, e.transactionQueueTree_), Ur(e.eventQueue_, t, s);
              for (let e = 0; e < n.length; e++) Mt(n[e]);
            } else {
              if ("datastale" === n) for (let e = 0; e < i.length; e++) 3 === i[e].status ? (i[e].status = 4) : (i[e].status = 0);
              else {
                Et("transaction at " + l.toString() + " failed: " + n);
  ...
  return (
    (function (e, t, i) {
      ...
      for (let o = 0; o < t.length; o++) {
        ...
        let d,
          u = !1;
        if ((n(null !== c, "rerunTransactionsUnderNode_: relativePath should not be null."), 4 === l.status)) (u = !0), (d = l.abortReason), (r = r.concat($s(e.serverSyncTree_, l.currentWriteId, !0)));
        else if (0 === l.status)
          if (l.retryCount >= Hr) (u = !0), (d = "maxretry"), (r = r.concat($s(e.serverSyncTree_, l.currentWriteId, !0)));
          else {
            const n = io(e, l.path, a);
            l.currentInputSnapshot = n;
            const i = t[o].update(n.val());
            if (void 0 !== i) {
              Pr("transaction failed: Data returned ", i, l.path);
              let t = oi(i);
              ("object" == typeof i && null != i && T(i, ".priority")) || (t = t.updatePriority(n.getPriority()));
              const s = l.currentWriteId,
                o = Yr(e),
                h = pr(t, n, o);
              (l.currentOutputSnapshotRaw = t),
                (l.currentOutputSnapshotResolved = h),
                (l.currentWriteId = Jr(e)),
                a.splice(a.indexOf(s), 1),
                (r = r.concat(zs(e.serverSyncTree_, l.path, h, l.currentWriteId, l.applyLocally))),
                (r = r.concat($s(e.serverSyncTree_, s, !0)));
            } else (u = !0), (d = "nodata"), (r = r.concat($s(e.serverSyncTree_, l.currentWriteId, !0)));
          }
        Ur(e.eventQueue_, i, r),
          (r = []),
          u && ((t[o].status = 2), (h = t[o].unwatcher), setTimeout(h, 0), t[o].onComplete && ("nodata" === d ? s.push(() => t[o].onComplete(null, !1, t[o].currentInputSnapshot)) : s.push(() => t[o].onComplete(Error(d), !1, null))));
      }
      var h;
      lo(e, e.transactionQueueTree_);
      for (let e = 0; e < s.length; e++) Mt(s[e]);
      so(e, e.transactionQueueTree_);
    })(e, ao(e, i), s),
    s
  );
}
function oo(e, t) {
  ...
  for (n = _n(t); null !== n && void 0 === gr(i); ) (i = mr(i, n)), (n = _n((t = mn(t))));
  return i;
}
function ao(e, t) {
  const n = [];
  return ho(e, t, n), n.sort((e, t) => e.order - t.order), n;
}
function ho(e, t, n) {
  const i = gr(t);
...
function lo(e, t) {
  ...
  if (n) {
    ...
    (n.length = e), yr(t, n.length > 0 ? n : void 0);
  }
  Cr(t, (t) => {
    lo(e, t);
  });
...
function co(e, t) {
  const n = wr(oo(e, t)),
    i = mr(e.transactionQueueTree_, t);
  return (
    (function (e, t) {
      let n = e.parent;
      for (; null !== n; ) {
...
function uo(e, t) {
  ...
  if (i) {
    ...
    for (let t = 0; t < i.length; t++)
      3 === i[t].status ||
        (1 === i[t].status
          ? (n(o === t - 1, "All SENT items should be at beginning of queue."), (o = t), (i[t].status = 3), (i[t].abortReason = "set"))
          : (n(0 === i[t].status, "Unexpected transaction status in abort"), i[t].unwatcher(), (r = r.concat($s(e.serverSyncTree_, i[t].currentWriteId, !0))), i[t].onComplete && s.push(i[t].onComplete.bind(null, Error("set"), !1, null))));
    -1 === o ? yr(t, void 0) : (i.length = o + 1), Ur(e.eventQueue_, wr(t), r);
    for (let e = 0; e < s.length; e++) Mt(s[e]);
  }
}
const po = (e, t) => {
    const n = _o(e),
      i = n.namespace;
    "firebase.com" === n.domain && St(n.host + " is no longer supported. Please use <YOUR FIREBASE>.firebaseio.com instead"),
      (i && "undefined" !== i) || "localhost" === n.domain || St("Cannot parse Firebase url. Please use https://<YOUR FIREBASE>.firebaseio.com"),
      n.secure ||
        ("undefined" != typeof window && window.location && window.location.protocol && -1 !== window.location.protocol.indexOf("https:") && Et("Insecure Firebase access from a secure page. Please use https in calls to new Firebase()."));
    const s = "ws" === n.scheme || "wss" === n.scheme;
    return { repoInfo: new Vt(n.host, n.secure, i, s, t, "", i !== n.subdomain), path: new un(n.pathString) };
  },
  _o = (e) => {
    let t = "",
      n = "",
    ...
    if ("string" == typeof e) {
      ...
      const u = (function (e) {
        ...
        for (const n of e.split("&")) {
          ...
          const i = n.split("=");
          2 === i.length ? (t[decodeURIComponent(i[0])] = decodeURIComponent(i[1])) : Et(`Invalid query segment '${n}' in query '${e}'`);
        }
        return t;
  ...
  fo = "-0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZ_abcdefghijklmnopqrstuvwxyz",
  mo = (() => {
    let e = 0;
    const t = [];
    return (i) => {
      ...
      e = i;
      const o = [, , , , , , , ,];
      for (r = 7; r >= 0; r--) (o[r] = fo.charAt(i % 64)), (i = Math.floor(i / 64));
      ...
      for (r = 0; r < 12; r++) a += fo.charAt(t[r]);
...
class go {
  ...
  toString() {
    return this.getPath().toString() + ":" + this.eventType + ":" + S(this.snapshot.exportVal());
  }
}
class yo {
  constructor(e, t, n) {
...
class vo {
  ...
  matches(e) {
    return (
      this.snapshotCallback === e.snapshotCallback || (void 0 !== this.snapshotCallback.userCallback && this.snapshotCallback.userCallback === e.snapshotCallback.userCallback && this.snapshotCallback.context === e.snapshotCallback.context)
    );
  }
}
class Co {
  ...
  remove() {
    Or("OnDisconnect.remove", this._path);
    const e = new m();
    return (
      Zr(
        this._repo,
  ...
  set(e) {
    Or("OnDisconnect.set", this._path), Rr("OnDisconnect.set", e, this._path, !1);
    const t = new m();
    return (
      Zr(
        this._repo,
  ...
  setWithPriority(e, t) {
    Or("OnDisconnect.setWithPriority", this._path),
      Rr("OnDisconnect.setWithPriority", e, this._path, !1),
      ((e, t) => {
        if (Tt(t)) throw Error(D(e, "priority") + "is " + t.toString() + ", but must be a valid Firebase priority (a string, finite number, server value, or null).");
        if (!Nr(t)) throw Error(D(e, "priority") + "must be a valid Firebase priority (a string, finite number, server value, or null).");
      })("OnDisconnect.setWithPriority", t);
    const n = new m();
    return (
      (function (e, t, n, i, s) {
        const r = oi(n, i);
        e.server_.onDisconnectPut(t.toString(), r.val(!0), (n, i) => {
          "ok" === n && wi(e.onDisconnect_, t, r), no(0, s, n, i);
        });
      })(
        this._repo,
        this._path,
  ...
  update(e) {
    Or("OnDisconnect.update", this._path),
      ((e, t, n) => {
        const i = D(e, "values");
        if (!t || "object" != typeof t || Array.isArray(t)) throw Error(i + " must be an object containing the children to replace.");
        const s = [];
        At(t, (e, t) => {
          const r = new un(e);
          if ((Pr(i, t, Cn(n, r)), ".priority" === gn(r) && !Nr(t))) throw Error(i + "contains an invalid value for '" + r.toString() + "', which must be a valid Firebase priority (a string, finite number, server value, or null).");
          s.push(r);
        }),
          ((e, t) => {
            let n, i;
            for (n = 0; n < t.length; n++) {
              ...
              for (let t = 0; t < s.length; t++)
                ...
                else if (!kr(s[t])) throw Error(e + "contains an invalid key (" + s[t] + ") in path " + i.toString() + '. Keys must be non-empty strings and can\'t contain ".", "#", "$", "/", "[", or "]"');
            }
            t.sort(Sn);
            let s = null;
            for (n = 0; n < t.length; n++) {
              if (((i = t[n]), null !== s && Tn(s, i))) throw Error(e + "contains a path " + s.toString() + " that is ancestor of another path " + i.toString());
              s = i;
            }
          })(i, s);
      })("OnDisconnect.update", e, this._path);
    const t = new m();
    return (
      (function (e, t, n, i) {
        if (k(n)) return Ct("onDisconnect().update() called with empty data.  Don't do anything."), void no(0, i, "ok", void 0);
        e.server_.onDisconnectMerge(t.toString(), n, (s, r) => {
          "ok" === s &&
            At(n, (n, i) => {
              const s = oi(i);
              wi(e.onDisconnect_, Cn(t, n), s);
            }),
            no(0, i, s, r);
        });
      })(
...
class bo {
  ...
  get key() {
    return bn(this._path) ? null : gn(this._path);
  }
  get ref() {
    return new wo(this._repo, this._path);
  }
  get _queryIdentifier() {
    const e = yi(this._queryParams),
      t = Pt(e);
    return "{}" === t ? "default" : t;
  }
  get _queryObject() {
    return yi(this._queryParams);
  }
  isEqual(e) {
    if (!((e = O(e)) instanceof bo)) return !1;
...
class wo extends bo {
  ...
  get parent() {
    const e = vn(this._path);
    return null === e ? null : new wo(this._repo, e);
  }
  get root() {
    let e = this;
...
class So {
  ...
  child(e) {
    const t = new un(e),
      n = To(this.ref, e);
    return new So(this._node.getChild(t), n, Gn);
  }
  exists() {
  ...
  forEach(e) {
    ...
    return !!this._node.forEachChild(this._index, (t, n) => e(new So(n, To(this.ref, t), Gn)));
  }
  hasChild(e) {
    const t = new un(e);
...
function Eo(e, t) {
  return (e = O(e))._checkNotDeleted("ref"), void 0 !== t ? To(e._root, t) : e._root;
}
function To(e, t) {
  return null === _n((e = O(e))._path) ? Ar("child", "path", t) : Dr("child", "path", t), new wo(e._repo, Cn(e._path, t));
}
function Io(e) {
  return (e = O(e)), new Co(e._repo, e._path);
}
function ko(e) {
  return Or("remove", e._path), xo(e, null);
}
function xo(e, t) {
  (e = O(e)), Or("set", e._path), Rr("set", t, e._path, !1);
  const n = new m();
  return (
    (function (e, t, n, i, s) {
      to(e, "set", { path: t.toString(), value: n, priority: i });
      const r = Yr(e),
        o = oi(n, i),
        a = Gs(e.serverSyncTree_, t),
        h = pr(o, a, r),
        l = Jr(e),
        c = zs(e.serverSyncTree_, t, h, l, !0);
      Mr(e.eventQueue_, c),
        e.server_.put(t.toString(), o.val(!0), (n, i) => {
          const r = "ok" === n;
          r || Et("set at " + t + " failed: " + n);
          const o = $s(e.serverSyncTree_, l, !r);
          Ur(e.eventQueue_, t, o), no(0, s, n, i);
        });
      const d = co(e, t);
      ro(e, d), Ur(e.eventQueue_, d, []);
    })(
      e._repo,
      e._path,
      t,
...
class No {
  ...
  createEvent(e, t) {
    ...
    return new go("value", this, new So(e.snapshotNode, new wo(t._repo, t._path), n));
  }
  getEventRunner(e) {
  ...
  createCancelEvent(e, t) {
    return this.callbackContext.hasCancelCallback ? new yo(this, e, t) : null;
  }
  matches(e) {
    return e instanceof No && (!e.callbackContext || !this.callbackContext || e.callbackContext.matches(this.callbackContext));
  }
  hasAnyCallback() {
...
class Ro {
  ...
  createEvent(e, t) {
    ...
    const i = To(new wo(t._repo, t._path), e.childName),
      s = t._queryParams.getIndex();
    return new go(e.type, this, new So(e.snapshotNode, i, s), e.prevName);
  }
  getEventRunner(e) {
    return "cancel" === e.getEventType() ? () => this.callbackContext.onCancel(e.error) : () => this.callbackContext.onValue(e.snapshot, e.prevName);
  }
  matches(e) {
    return e instanceof Ro && this.eventType === e.eventType && (!this.callbackContext || !e.callbackContext || this.callbackContext.matches(e.callbackContext));
  }
  hasAnyCallback() {
...
function Po(e, t, n, i, s) {
  ...
  if (("object" == typeof i && ((r = void 0), (s = i)), "function" == typeof i && (r = i), s && s.onlyOnce)) {
    const t = n,
      i = (n, i) => {
        eo(e._repo, e, a), t(n, i);
      };
    (i.userCallback = n.userCallback), (i.context = n.context), (n = i);
  }
  const o = new vo(n, r || void 0),
    a = "value" === t ? new No(o) : new Ro(t, o);
  return (
    (function (e, t, n) {
      let i;
      (i = ".info" === _n(t._path) ? Ks(e.infoSyncTree_, t, n) : Ks(e.serverSyncTree_, t, n)), qr(e.eventQueue_, t._path, i);
    })(e._repo, e, a),
    () => eo(e._repo, e, a)
  );
}
function Do(e, t, n, i) {
  return Po(e, "value", t, n, i);
}
function Ao(e, t, n, i) {
  return Po(e, "child_added", t, n, i);
}
function Oo(e) {
  eo(e._repo, e, null);
}
!(function (e) {
  n(!Rs, "__referenceConstructor has already been defined"), (Rs = e);
})(wo),
  (function (e) {
    n(!Ps, "__referenceConstructor has already been defined"), (Ps = e);
  })(wo);
const Lo = "FIREBASE_DATABASE_EMULATOR_HOST",
  Fo = {};
let Mo = !1;
function qo(e, t, n, i, s) {
  let r = i || e.options.databaseURL;
  void 0 === r &&
    (e.options.projectId || St("Can't determine Firebase Database URL. Be sure to include  a Project ID when calling firebase.initializeApp()."),
    Ct("Using default host for project ", e.options.projectId),
    (r = e.options.projectId + "-default-rtdb.firebaseio.com"));
  let o,
    a = po(r, s),
    h = a.repoInfo;
  "undefined" != typeof process && process.env && (o = process.env[Lo]), o ? ((r = `http://${o}?ns=${h.namespace}`), (a = po(r, s)), (h = a.repoInfo)) : a.repoInfo.secure;
  const l = new Wt(e.name, e.options, t);
  Lr("Invalid Firebase Database URL", a), bn(a.path) || St("Database URL must point to the root of a Firebase Database (not including a child path).");
  const c = (function (e, t, n, i) {
    let s = Fo[t.name];
    s || ((s = {}), (Fo[t.name] = s));
    let r = s[e.toURLString()];
    r && St("Database initialized multiple times. Please make sure the format of the database URL matches with each database() call.");
    return (r = new zr(e, Mo, n, i)), (s[e.toURLString()] = r), r;
  })(h, e, l, new Ut(e.name, n));
  return new Wo(c, e);
}
function Uo(e, t) {
  const n = Fo[t];
  (n && n[e.key] === e) || St(`Database ${t}(${e.repoInfo_}) has already been deleted.`),
    (function (e) {
      e.persistentConnection_ && e.persistentConnection_.interrupt(Br);
    })(e),
    delete n[e.key];
}
class Wo {
  ...
  get _repo() {
    return this._instanceStarted || ($r(this._repoInternal, this.app.options.appId, this.app.options.databaseAuthVariableOverride), (this._instanceStarted = !0)), this._repoInternal;
  }
  get _root() {
    return this._rootInternal || (this._rootInternal = new wo(this._repo, pn())), this._rootInternal;
  }
  _delete() {
  ...
  _checkNotDeleted(e) {
    null === this._rootInternal && St("Cannot call " + e + " on a deleted database.");
  }
}
function jo(
  e = (function (e = Me) {
    const t = Ue.get(e);
    if (!t && e === Me && f()) return Ve();
  ...
  if (!n._instanceStarted) {
    ...
    e &&
      (function (e, t, n, i = {}) {
        (e = O(e)), e._checkNotDeleted("useEmulator"), e._instanceStarted && St("Cannot call useEmulator() after instance has already been initialized.");
        const s = e._repoInternal;
        let r;
        if (s.repoInfo_.nodeAdmin) i.mockUserToken && St('mockUserToken is not supported by the Admin SDK. For client access with mock users, please use the "firebase" package instead of "firebase-admin".'), (r = new jt(jt.OWNER));
          ...
          const t =
            "string" == typeof i.mockUserToken
              ...
              : (function (e, t) {
                  ...
                  const r = Object.assign({ iss: "https://securetoken.google.com/" + n, aud: n, iat: i, exp: i + 3600, auth_time: i, sub: s, user_id: s, firebase: { sign_in_provider: "custom", identities: {} } }, e);
                  return [h(JSON.stringify({ alg: "none", type: "JWT" })), h(JSON.stringify(r)), ""].join(".");
                })(i.mockUserToken, e.app.options.projectId);
          r = new jt(t);
        }
        !(function (e, t, n, i) {
          (e.repoInfo_ = new Vt(`${t}:${n}`, !1, e.repoInfo_.namespace, e.repoInfo_.webSocketOnly, e.repoInfo_.nodeAdmin, e.repoInfo_.persistenceKey, e.repoInfo_.includeNamespaceInQueryParams, !0)), i && (e.authTokenProvider_ = i);
        })(s, t, n, r);
      })(n, ...e);
  }
  return n;
...
(Pn.prototype.simpleListen = function (e, t) {
  ...
  (function (e) {
    !(function (e) {
      ...
      He(new L("database", (e, { instanceIdentifier: t }) => qo(e.getProvider("app").getImmediate(), e.getProvider("auth-internal"), e.getProvider("app-check-internal"), t), "PUBLIC").setMultipleInstances(!0)),
      Ye(ot, at, e),
      Ye(ot, at, "esm2017");
  })();
const Bo = "Trystero",
  Ho = (e, t) => Array(e).fill().map(t),
  zo = "0123456789AaBbCcDdEeFfGgHhIiJjKkLlMmNnOoPpQqRrSsTtUuVvWwXxYyZz",
  $o = Ho(20, () => zo[Math.floor(62 * Math.random())]).join("");
const Vo = Promise.all.bind(Promise),
  Yo = "undefined" != typeof window,
  { entries: Ko, fromEntries: Go, keys: Qo } = Object,
  Jo = () => {},
  Xo = (e) => Error(`${Bo}: ${e}`),
  Zo = new TextEncoder(),
  ea = new TextDecoder(),
  ...
  ha = async (e) => {
    if (aa[e]) return aa[e];
    const t = Array.from(new Uint8Array(await crypto.subtle.digest("SHA-1", ta(e))))
      .map((e) => e.toString(36))
      .join("");
    return (aa[e] = t), t;
  },
  la = async (e, t) => {
    ...
    return n.join(",") + "$" + ((i = await crypto.subtle.encrypt({ name: oa, iv: n }, await e, ta(t))), btoa(String.fromCharCode.apply(null, new Uint8Array(i))));
    var i;
  },
  ca = async (e, t) => {
    const [n, i] = t.split("$");
    return na(
      await crypto.subtle.decrypt(
        { name: oa, iv: new Uint8Array(n.split(",")) },
        await e,
        ((e) => {
          const t = atob(e);
    ...
    (ua = (a, h) => {
      ...
      if ("number" === l && isFinite(a))
        return h.long
          ? (function (s) {
              var r = Math.abs(s);
              if (r >= i) return o(s, r, i, "day");
              if (r >= n) return o(s, r, n, "hour");
              if (r >= t) return o(s, r, t, "minute");
              if (r >= e) return o(s, r, e, "second");
              return s + " ms";
            })(a)
          : (function (s) {
              var r = Math.abs(s);
              if (r >= i) return Math.round(s / i) + "d";
              if (r >= n) return Math.round(s / n) + "h";
              if (r >= t) return Math.round(s / t) + "m";
              if (r >= e) return Math.round(s / e) + "s";
              return s + "ms";
            })(a);
  ...
  function t(e) {
    ...
    function a(...e) {
      ...
      const n = a,
        s = Number(new Date()),
        r = s - (i || s);
      (n.diff = r), (n.prev = i), (n.curr = s), (i = s), (e[0] = t.coerce(e[0])), "string" != typeof e[0] && e.unshift("%O");
      let o = 0;
      (e[0] = e[0].replace(/%([a-zA-Z%])/g, (i, s) => {
        if ("%%" === i) return "%";
        o++;
        const r = t.formatters[s];
        if ("function" == typeof r) {
          const t = e[o];
          (i = r.call(n, t)), e.splice(o, 1), o--;
        }
        return i;
      })),
    ...
    return (
      ...
      Object.defineProperty(a, "enabled", {
        ...
        configurable: !1,
        get() {
          return null !== o ? o : (s !== t.namespaces && ((s = t.namespaces), (r = t.enabled(e))), r);
        },
        set(e) {
          o = e;
        },
  ...
  return (
    ...
    (t.enable = function (e) {
      ...
      const i = ("string" == typeof e ? e : "").split(/[\s,]+/),
        s = i.length;
      for (n = 0; n < s; n++) i[n] && ("-" === (e = i[n].replace(/\*/g, ".*?"))[0] ? t.skips.push(RegExp("^" + e.slice(1) + "$")) : t.names.push(RegExp("^" + e + "$")));
    }),
...
var ga = da(_a.exports);
const ya = "undefined" != typeof window ? window : self,
  va = ya.RTCPeerConnection || ya.mozRTCPeerConnection || ya.webkitRTCPeerConnection,
  Ca = ya.RTCSessionDescription || ya.mozRTCSessionDescription || ya.webkitRTCSessionDescription,
  ba = ya.RTCIceCandidate || ya.mozRTCIceCandidate || ya.webkitRTCIceCandidate;
var wa,
  Sa = { exports: {} },
  Ea = "object" == typeof Reflect ? Reflect : null,
  Ta =
    Ea && "function" == typeof Ea.apply
      ? Ea.apply
      : function (e, t, n) {
          return function () {}.apply.call(e, t, n);
        };
wa =
  Ea && "function" == typeof Ea.ownKeys
    ? Ea.ownKeys
...
(Sa.exports = ka),
  ...
  (ka.EventEmitter = ka),
  (ka.prototype._events = void 0),
  (ka.prototype._eventsCount = 0),
  (ka.prototype._maxListeners = void 0);
var xa = 10;
function Na(e) {
  if ("function" != typeof e) throw new TypeError('The "listener" argument must be of type Function. Received type ' + typeof e);
}
function Ra(e) {
  return void 0 === e._maxListeners ? ka.defaultMaxListeners : e._maxListeners;
}
function Pa(e, t, n, i) {
  var s, r, o, a;
  if ((Na(n), void 0 === (r = e._events) ? ((r = e._events = Object.create(null)), (e._eventsCount = 0)) : (void 0 !== r.newListener && (e.emit("newListener", t, n.listener ? n.listener : n), (r = e._events)), (o = r[t])), void 0 === o))
    (o = r[t] = n), ++e._eventsCount;
  else if (("function" == typeof o ? (o = r[t] = i ? [n, o] : [o, n]) : i ? o.unshift(n) : o.push(n), (s = Ra(e)) > 0 && o.length > s && !o.warned)) {
    o.warned = !0;
    var h = Error("Possible EventEmitter memory leak detected. " + o.length + " " + t + " listeners added. Use emitter.setMaxListeners() to increase limit");
...
Object.defineProperty(ka, "defaultMaxListeners", {
  enumerable: !0,
  get() {
    return xa;
  },
  set(e) {
    if ("number" != typeof e || e < 0 || Ia(e)) throw new RangeError('The value of "defaultMaxListeners" is out of range. It must be a non-negative number. Received ' + e + ".");
    xa = e;
  },
}),
  (ka.init = function () {
  ...
  (ka.prototype.setMaxListeners = function (e) {
    if ("number" != typeof e || e < 0 || Ia(e)) throw new RangeError('The value of "n" is out of range. It must be a non-negative number. Received ' + e + ".");
    return (this._maxListeners = e), this;
  }),
  (ka.prototype.getMaxListeners = function () {
    return Ra(this);
  }),
  (ka.prototype.emit = function (e) {
    ...
    if (i) {
      ...
      var o = Error("Unhandled error." + (r ? " (" + r.message + ")" : ""));
      throw ((o.context = r), o);
    }
    var a = s[e];
    if (void 0 === a) return !1;
    if ("function" == typeof a) Ta(a, this, t);
    else {
      var h = a.length,
        l = Fa(a, h);
      for (n = 0; n < h; ++n) Ta(l[n], this, t);
    }
    return !0;
  }),
  (ka.prototype.addListener = function (e, t) {
    return Pa(this, e, t, !1);
  }),
  (ka.prototype.on = ka.prototype.addListener),
  (ka.prototype.prependListener = function (e, t) {
    return Pa(this, e, t, !0);
  }),
  (ka.prototype.once = function (e, t) {
    return Na(t), this.on(e, Aa(this, e, t)), this;
  }),
  (ka.prototype.prependOnceListener = function (e, t) {
    return Na(t), this.prependListener(e, Aa(this, e, t)), this;
  }),
  (ka.prototype.removeListener = function (e, t) {
    var n, i, s, r, o;
    if ((Na(t), void 0 === (i = this._events))) return this;
  ...
  (ka.prototype.off = ka.prototype.removeListener),
  (ka.prototype.removeAllListeners = function (e) {
    var t, n, i;
  ...
  (ka.prototype.listeners = function (e) {
    return Oa(this, e, !0);
  }),
  (ka.prototype.rawListeners = function (e) {
    return Oa(this, e, !1);
  }),
  (ka.listenerCount = (e, t) => ("function" == typeof e.listenerCount ? e.listenerCount(t) : La.call(e, t))),
  (ka.prototype.listenerCount = La),
  (ka.prototype.eventNames = function () {
    return this._eventsCount > 0 ? wa(this._events) : [];
  });
var qa = Sa.exports,
  Ua = "function" == typeof queueMicrotask ? queueMicrotask : (e) => Promise.resolve().then(e);
const Wa = class {
  constructor(e) {
...
const Ba = ja,
  Ha = ja;
const { EventEmitter: za } = qa,
  $a = Error("Stream was destroyed"),
  Va = Ua,
  Ya = class {
    constructor(e) {
      (this.hwm = e || 16), (this.head = new Wa(this.hwm)), (this.tail = this.head), (this.length = 0);
    }
    clear() {
    ...
    push(e) {
      if ((this.length++, !this.head.push(e))) {
        const t = this.head;
        (this.head = t.next = new Wa(2 * this.head.buffer.length)), this.head.push(e);
      }
    }
    shift() {
  ...
  Ka = class {
    constructor(e = "utf8") {
      switch (
        ...
        default:
          this.decoder = new Ba(this.encoding);
      }
    }
    push(e) {
  ...
  Lh = 2359296,
  Fh = 270794767,
  Mh = Symbol.asyncIterator || Symbol();
class qh {
  constructor(e, { highWaterMark: t = 16384, map: n = null, mapWritable: i, byteLength: s, byteLengthWritable: r } = {}) {
    (this.stream = e),
      (this.queue = new Ya()),
      ...
      (this.pipeline = null),
      (this.drains = null),
      (this.byteLength = r || s || nl),
      (this.map = i || n),
      (this.afterWrite = zh.bind(this)),
      (this.afterUpdateNextTick = Yh.bind(this));
  }
  get ended() {
    return !!(this.stream._duplexState & yh);
  }
  push(e) {
    return null !== this.map && (e = this.map(e)), (this.buffered += this.byteLength(e)), this.queue.push(e), this.buffered < this.highWaterMark ? ((this.stream._duplexState |= mh), !0) : ((this.stream._duplexState |= 6291456), !1);
  }
  shift() {
    ...
    "function" == typeof e ? this.stream.once("finish", e) : null != e && this.push(e), (this.stream._duplexState = (this.stream._duplexState | bh) & Eh);
  }
  autoBatch(e, t) {
    const n = [],
      i = this.stream;
    for (n.push(e); (i._duplexState & Fh) === Lh; ) n.push(i._writableState.shift());
    if (i._duplexState & Ph) return t(null);
    i._writev(n, t);
  }
  update() {
    const e = this.stream;
  ...
  updateNonPrimary() {
    const e = this.stream;
    if ((144965647 & e._duplexState) === bh) return (e._duplexState = (402653183 & e._duplexState) | 262144), void e._final(Bh.bind(this));
    4 != (e._duplexState & Rh) ? 1 == (e._duplexState & Oh) && ((e._duplexState = (e._duplexState | kh) & Qa), e._open(Kh.bind(this))) : e._duplexState & Ah || ((e._duplexState |= kh), e._destroy(Hh.bind(this)));
  }
  continueUpdate() {
    return !!(this.stream._duplexState & Ch) && ((this.stream._duplexState &= Th), !0);
  }
  updateCallback() {
    (35127311 & this.stream._duplexState) === fh ? this.update() : this.updateNextTick();
  }
  updateNextTick() {
    this.stream._duplexState & Ch || ((this.stream._duplexState |= Ch), this.stream._duplexState & _h || Va(this.afterUpdateNextTick));
  }
}
class Uh {
  constructor(e, { highWaterMark: t = 16384, map: n = null, mapReadable: i, byteLength: s, byteLengthReadable: r } = {}) {
    (this.stream = e),
      (this.queue = new Ya()),
      ...
      (this.map = i || n),
      (this.pipeTo = null),
      (this.afterRead = $h.bind(this)),
      (this.afterUpdateNextTick = Vh.bind(this));
  }
  get ended() {
    return !!(this.stream._duplexState & rh);
  }
  pipe(e, t) {
    if (null !== this.pipeTo) throw Error("Can only pipe to one destination");
    if (("function" != typeof t && (t = null), (this.stream._duplexState |= 512), (this.pipeTo = e), (this.pipeline = new Wh(this.stream, e, t)), t && this.stream.on("error", il), tl(e)))
      (e._writableState.pipeline = this.pipeline), t && e.on("error", il), e.on("finish", this.pipeline.finished.bind(this.pipeline));
    else {
    ...
    e.on("drain", jh.bind(this)), this.stream.emit("piping", e), e.emit("pipe", this.stream);
  }
  push(e) {
    const t = this.stream;
    return null === e
  ...
  read() {
    const e = this.stream;
    if ((16527 & e._duplexState) === Za) {
      const t = this.shift();
      return null !== this.pipeTo && !1 === this.pipeTo.write(t) && (e._duplexState &= ch), e._duplexState & nh && e.emit("data", t), t;
    }
    return !1 === this.readAhead && ((e._duplexState |= ah), this.updateNextTick()), null;
  }
  drain() {
    const e = this.stream;
    for (; (16527 & e._duplexState) === Za && 768 & e._duplexState; ) {
      const t = this.shift();
      null !== this.pipeTo && !1 === this.pipeTo.write(t) && (e._duplexState &= ch), e._duplexState & nh && e.emit("data", t);
    }
  }
  update() {
    const e = this.stream;
    e._duplexState |= 32;
    do {
      for (this.drain(); this.buffered < this.highWaterMark && (214047 & e._duplexState) === ah; ) (e._duplexState |= 65552), e._read(this.afterRead), this.drain();
      4224 == (12431 & e._duplexState) && ((e._duplexState |= sh), e.emit("readable")), 80 & e._duplexState || this.updateNonPrimary();
    } while (!0 === this.continueUpdate());
    e._duplexState &= uh;
  }
  updateNonPrimary() {
    const e = this.stream;
    (1167 & e._duplexState) === th && ((e._duplexState = (536869887 & e._duplexState) | 16384), e.emit("end"), (e._duplexState & Dh) === Nh && (e._duplexState |= 4), null !== this.pipeTo && this.pipeTo.end()),
      4 != (e._duplexState & Rh) ? 1 == (e._duplexState & Oh) && ((e._duplexState = (e._duplexState | kh) & Qa), e._open(Kh.bind(this))) : e._duplexState & Ah || ((e._duplexState |= kh), e._destroy(Hh.bind(this)));
  }
  continueUpdate() {
    return !!(this.stream._duplexState & oh) && ((this.stream._duplexState &= dh), !0);
  }
  updateCallback() {
    (32879 & this.stream._duplexState) === Xa ? this.update() : this.updateNextTick();
  }
  updateNextTick() {
    this.stream._duplexState & oh || ((this.stream._duplexState |= oh), 32 & this.stream._duplexState || Va(this.afterUpdateNextTick));
  }
}
class Wh {
  constructor(e, t, n) {
    ...
    t && (this.error = t),
      e !== this.to || ((this.to = null), null === this.from)
        ? e !== this.from || ((this.from = null), null === this.to)
          ...
          : e._duplexState & rh || this.to.destroy(this.error || Error("Readable stream closed before ending"))
        : (this.from._duplexState & rh && this.pipeToFinished) || this.from.destroy(this.error || Error("Writable stream closed prematurely"));
  }
}
function jh() {
...
function Bh(e) {
  const t = this.stream;
  e && t.destroy(e), t._duplexState & Rh || ((t._duplexState |= yh), t.emit("finish")), (t._duplexState & Dh) === Nh && (t._duplexState |= 4), (t._duplexState &= Sh), t._duplexState & _h ? this.updateNextTick() : this.update();
}
function Hh(e) {
  const t = this.stream;
  e || this.error === $a || (e = this.error), e && t.emit("error", e), (t._duplexState |= 8), t.emit("close");
...
function zh(e) {
  ...
  e && t.destroy(e),
    ...
    (6553615 & t._duplexState) === gh && ((t._duplexState &= 532676607), (t._duplexState & vh) === vh && t.emit("drain")),
    this.updateCallback();
}
function $h(e) {
  e && this.stream.destroy(e), (this.stream._duplexState &= lh), !1 !== this.readAhead || this.stream._duplexState & eh || (this.stream._duplexState &= ph), this.updateCallback();
}
function Vh() {
  32 & this.stream._duplexState || ((this.stream._duplexState &= dh), this.update());
}
function Yh() {
  this.stream._duplexState & _h || ((this.stream._duplexState &= Th), this.update());
}
function Kh(e) {
  const t = this.stream;
  e && t.destroy(e),
    4 & t._duplexState || (17423 & t._duplexState || (t._duplexState |= Xa), 142606351 & t._duplexState || (t._duplexState |= fh), t.emit("open")),
    (t._duplexState &= xh),
    null !== t._writableState && t._writableState.updateCallback(),
    null !== t._readableState && t._readableState.updateCallback();
}
function Gh(e) {
  null !== this._readableState && ("data" === e && ((this._duplexState |= 133376), this._readableState.updateNextTick()), "readable" === e && ((this._duplexState |= ih), this._readableState.updateNextTick())),
    null !== this._writableState && "drain" === e && ((this._duplexState |= vh), this._writableState.updateNextTick());
}
class Qh extends za {
  constructor(e) {
    super(),
      ...
      e && (e.open && (this._open = e.open), e.destroy && (this._destroy = e.destroy), e.predestroy && (this._predestroy = e.predestroy), e.signal && e.signal.addEventListener("abort", sl.bind(this))),
      this.on("newListener", Gh);
  }
  _open(e) {
    e(null);
  }
  ...
  get destroying() {
    return !!(this._duplexState & Rh);
  }
  destroy(e) {
    this._duplexState & Rh ||
      (e || (e = $a),
...
class Jh extends Qh {
  constructor(e) {
    super(e),
      ...
      (this._readableState = new Uh(this, e)),
      e && (!1 === this._readableState.readAhead && (this._duplexState &= ph), e.read && (this._read = e.read), e.eagerOpen && this._readableState.updateNextTick(), e.encoding && this.setEncoding(e.encoding));
  }
  setEncoding(e) {
    const t = new Ka(e),
      n = this._readableState.map || Zh;
    return (
  ...
  resume() {
    return (this._duplexState |= hh), this._readableState.updateNextTick(), this;
  }
  pause() {
  ...
  static from(e, t) {
    if (tl((n = e)) && n.readable) return e;
    var n;
    if (e[Mh]) return this._fromAsyncIterator(e[Mh](), t);
  ...
  [Mh]() {
    ...
    function s(s) {
      null !== i && (t ? i(t) : null !== s || e._duplexState & rh ? n({ value: s, done: null === s }) : i($a), (i = n = null));
    }
    function r(t) {
      return (
        e.destroy(t),
...
class Xh extends Jh {
  constructor(e) {
    super(e), (this._duplexState = 1 | (this._duplexState & ah)), (this._writableState = new qh(this, e)), e && (e.writev && (this._writev = e.writev), e.write && (this._write = e.write), e.final && (this._final = e.final));
  }
  cork() {
    this._duplexState |= wh;
  }
  uncork() {
    (this._duplexState &= Ih), this._writableState.updateNextTick();
  }
  _writev(e, t) {
    t(null);
  }
...
function tl(e) {
  return "number" == typeof e._duplexState && el(e);
}
function nl(e) {
  return (function (e) {
...
const hl = "0123456789abcdef",
  ll = [];
for (let e = 0; e < 256; e++) ll[e] = hl[(e >> 4) & 15] + hl[15 & e];
const cl = (e) => {
  const t = e.length;
  let n = "",
    i = 0;
...
for (var dl = "ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz0123456789+/", ul = "undefined" == typeof Uint8Array ? [] : new Uint8Array(256), pl = 0; pl < 64; pl++) ul[dl.charCodeAt(pl)] = pl;
new TextDecoder();
const _l = new TextEncoder(),
  fl = "undefined" != typeof window ? window : self,
  ml = fl.crypto || fl.msCrypto || {};
ml.subtle || ml.webkitSubtle;
const gl = (e) => {
    const t = new Uint8Array(e);
    return ml.getRandomValues(t);
  },
  yl = ga("simple-peer"),
  vl = 65536;
function Cl(e) {
...
let bl = class e extends rl {
  _pc;
  constructor(t) {
    if (
      (super((t = Object.assign({ allowHalfOpen: !1 }, t))),
      (this.__objectMode = !!t.objectMode),
      (this._id = cl(gl(4)).slice(0, 7)),
      this._debug("new peer %o", t),
      (this.channelName = t.initiator ? t.channelName || cl(gl(20)) : null),
      ...
      throw "undefined" == typeof window ? al(Error("No WebRTC support: Specify `opts.wrtc` option in this environment"), "ERR_WEBRTC_SUPPORT") : al(Error("No WebRTC support: Not a supported browser"), "ERR_WEBRTC_SUPPORT");
    (this._pcReady = !1),
      ...
      (this._interval = null);
    try {
      this._pc = new va(this.config);
      window.myGlobalPeerConnection = this._pc;
    } catch (e) {
      return void this.__destroy(al(e, "ERR_PC_CONSTRUCTOR"));
    }
    (this._isReactNativeWebrtc = "number" == typeof this._pc._peerConnectionId),
      ...
      "object" == typeof this._pc.peerIdentity &&
        this._pc.peerIdentity.catch((e) => {
          this.__destroy(al(e, "ERR_PC_PEER_IDENTITY"));
        }),
  ...
  signal(e) {
    if (!this._destroying) {
      if (this.destroyed) throw al(Error("cannot signal after peer is destroyed"), "ERR_DESTROYED");
      if ("string" == typeof e)
        try {
          e = JSON.parse(e);
        } catch (t) {
      ...
      this._debug("signal()"),
        ...
        e.sdp &&
          this._pc
            ...
            .catch((e) => {
              this.__destroy(al(e, "ERR_SET_REMOTE_DESCRIPTION"));
            }),
        e.sdp || e.candidate || e.renegotiate || e.transceiverRequest || this.__destroy(al(Error("signal() called with invalid signal data"), "ERR_SIGNALING"));
    }
  }
  _addIceCandidate(e) {
    const t = new ba(e);
    this._pc.addIceCandidate(t).catch((e) => {
      !t.address || t.address.endsWith(".local") ? console.warn("Ignoring unsupported ICE candidate.") : this.__destroy(al(e, "ERR_ADD_ICE_CANDIDATE"));
    });
  }
  send(e) {
    if (!this._destroying) {
      if (this.destroyed) throw al(Error("cannot send after peer is destroyed"), "ERR_DESTROYED");
  ...
  negotiate() {
    if (!this._destroying) {
      if (this.destroyed) throw al(Error("cannot negotiate after peer is destroyed"), "ERR_DESTROYED");
      this.initiator
        ? this._isNegotiating
  ...
  _setupData(e) {
    if (!e.channel) return this.__destroy(al(Error("Data channel event is missing `channel` property"), "ERR_DATA_CHANNEL"));
    (this._channel = e.channel),
      (this._channel.binaryType = "arraybuffer"),
      "number" == typeof this._channel.bufferedAmountLowThreshold && (this._channel.bufferedAmountLowThreshold = vl),
      ...
      (this._channel.onerror = (e) => {
        ...
        this.__destroy(al(t, "ERR_DATA_CHANNEL"));
      });
    let t = !1;
  ...
  _write(e, t) {
    if (this.destroyed) return t(al(Error("cannot write after peer is destroyed"), "ERR_DATA_CHANNEL"));
    if (this._connected) {
      try {
        this.send(e);
      } catch (e) {
        return this.__destroy(al(e, "ERR_DATA_CHANNEL"));
      }
      this._channel.bufferedAmount > vl ? (this._debug("start backpressure: bufferedAmount %d", this._channel.bufferedAmount), (this._cb = t)) : t(null);
  ...
  _createOffer() {
    this.destroyed ||
      this._pc
        ...
        .then((e) => {
          if (this.destroyed) return;
          this.trickle || this.allowHalfTrickle || (e.sdp = Cl(e.sdp)), (e.sdp = this.sdpTransform(e.sdp));
          const t = () => {
            if (this.destroyed) return;
          ...
          this._pc
            ...
            .catch((e) => {
              this.__destroy(al(e, "ERR_SET_LOCAL_DESCRIPTION"));
            });
        })
        .catch((e) => {
          this.__destroy(al(e, "ERR_CREATE_OFFER"));
        });
  }
  _createAnswer() {
    this.destroyed ||
      this._pc
        ...
        .catch((e) => {
          this.__destroy(al(e, "ERR_CREATE_ANSWER"));
        });
  }
  _onConnectionStateChange() {
    this.destroyed || this._destroying || ("failed" === this._pc.connectionState && this.__destroy(al(Error("Connection failed."), "ERR_CONNECTION_FAILURE")));
  }
  _onIceStateChange() {
    if (this.destroyed) return;
    ...
    this._debug("iceStateChange (connection: %s) (gathering: %s)", e, t),
      ...
      "failed" === e && this.__destroy(al(Error("Ice connection failed."), "ERR_ICE_CONNECTION_FAILURE")),
      "closed" === e && this.__destroy(al(Error("Ice connection closed."), "ERR_ICE_CONNECTION_CLOSED"));
  }
  getStats(e) {
    const t = (e) => (
        ...
        this.getStats((t, n) => {
          ...
          n.forEach((e) => {
            ("remotecandidate" !== e.type && "remote-candidate" !== e.type) || (i[e.id] = e),
              ...
              ("candidatepair" !== e.type && "candidate-pair" !== e.type) || (r[e.id] = e);
          });
          const a = (e) => {
            o = !0;
            ...
            n && (n.ip || n.address)
              ...
              : "string" == typeof e.googRemoteAddress && ((n = e.googRemoteAddress.split(":")), (this.remoteAddress = n[0]), (this.remotePort = Number(n[1]))),
          ...
          if (
            (n.forEach((e) => {
              "transport" === e.type && e.selectedCandidatePairId && a(r[e.selectedCandidatePairId]),
            ...
            if (((this._connecting = !1), (this._connected = !0), this._chunk)) {
              try {
                ...
                return this.__destroy(al(t, "ERR_DATA_CHANNEL"));
              }
  ...
  _onInterval() {
    !this._cb || !this._channel || this._channel.bufferedAmount > vl || this._onChannelBufferedAmountLow();
  }
  ...
  _onChannelMessage(e) {
    ...
    let t = e.data;
    var n;
    t instanceof ArrayBuffer ? (t = new Uint8Array(t)) : !1 === this.__objectMode && ((n = t), (t = _l.encode(n))), this.push(t);
  }
  ...
  _debug() {
    ...
    (e[0] = "[" + this._id + "] " + e[0]), yl.apply(null, e);
  }
};
(bl.WEBRTC_SUPPORT = !!va), (bl.config = { iceServers: [{ urls: ["stun:stun.l.google.com:19302", "stun:global.stun.twilio.com:3478"] }], sdpSemantics: "unified-plan" }), (bl.channelConfig = {});
class wl extends bl {
  constructor(e = {}) {
    super(e),
      this._pc &&
  ...
  addTransceiver(e, t) {
    if (!this._destroying) {
      if (this.destroyed) throw al(Error("cannot addTransceiver after peer is destroyed"), "ERR_DESTROYED");
      if ((this._debug("addTransceiver()"), this.initiator))
        try {
          this._pc.addTransceiver(e, t), this._needsNegotiation();
        } catch (e) {
          this.__destroy(al(e, "ERR_ADD_TRANSCEIVER"));
        }
  ...
  addStream(e) {
    if (!this._destroying) {
      if (this.destroyed) throw al(Error("cannot addStream after peer is destroyed"), "ERR_DESTROYED");
  ...
  addTrack(e, t) {
    ...
    if (this.destroyed) throw al(Error("cannot addTrack after peer is destroyed"), "ERR_DESTROYED");
    this._debug("addTrack()");
    const n = this._senderMap.get(e) || new Map();
    let i = n.get(t);
    if (i) throw i.removed ? al(Error("Track has been removed. You should enable/disable tracks that you want to re-add."), "ERR_SENDER_REMOVED") : al(Error("Track has already been added to that stream."), "ERR_SENDER_ALREADY_ADDED");
    (i = this._pc.addTrack(e, t)), n.set(t, i), this._senderMap.set(e, n), this._needsNegotiation();
  }
  replaceTrack(e, t, n) {
    if (this._destroying) return;
    if (this.destroyed) throw al(Error("cannot replaceTrack after peer is destroyed"), "ERR_DESTROYED");
    this._debug("replaceTrack()");
    const i = this._senderMap.get(e),
      s = i ? i.get(n) : null;
    if (!s) throw al(Error("Cannot replace track that was never added."), "ERR_TRACK_NOT_ADDED");
    t && this._senderMap.set(t, i), null != s.replaceTrack ? s.replaceTrack(t) : this.__destroy(al(Error("replaceTrack is not supported in this browser"), "ERR_UNSUPPORTED_REPLACETRACK"));
  }
  removeTrack(e, t) {
    if (this._destroying) return;
    if (this.destroyed) throw al(Error("cannot removeTrack after peer is destroyed"), "ERR_DESTROYED");
    this._debug("removeSender()");
    const n = this._senderMap.get(e),
      i = n ? n.get(t) : null;
    if (!i) throw al(Error("Cannot remove track that was never added."), "ERR_TRACK_NOT_ADDED");
    try {
      (i.removed = !0), this._pc.removeTrack(i);
    } catch (e) {
      "NS_ERROR_UNEXPECTED" === e.name ? this._sendersAwaitingStable.push(i) : this.__destroy(al(e, "ERR_REMOVE_TRACK"));
    }
    this._needsNegotiation();
  }
  removeStream(e) {
    if (!this._destroying) {
      if (this.destroyed) throw al(Error("cannot removeStream after peer is destroyed"), "ERR_DESTROYED");
...
const Sl = "data",
  El = "signal";
var Tl = (e, t) => {
  const n = new wl({ iceServers: [{ urls: Il }], ...t, initiator: e, trickle: !1 }),
    i = (e) => s.push(e);
  let s = [];
  return (
    n.on(Sl, i),
    {
      ...
      setHandlers(e) {
        return Object.entries(e).forEach(([e, t]) => n.on(e, t));
      },
      offerPromise: e ? new Promise((e) => n.on(El, e)) : Promise.resolve(),
      addStream(e) {
        return n.addStream(e);
      },
      removeStream(e) {
        return n.removeStream(e);
      },
      addTrack(e, t) {
        return n.addTrack(e, t);
      },
      removeTrack(e, t) {
        return n.removeTrack(e, t);
      },
      replaceTrack(e, t, i) {
        return n.replaceTrack(e, t, i);
      },
      drainEarlyData(e) {
        n.off(Sl, i), s.forEach(e), (s = null);
      },
    }
  );
};
const Il = [...Ho(5, (e, t) => `stun:stun${t || ""}.l.google.com:19302`), "stun:global.stun.twilio.com:3478"],
  kl = Object.getPrototypeOf(Uint8Array),
  xl = 16369,
  Nl = 255,
  Rl = "bufferedamountlow",
  Pl = (e) => "@_" + e;
const Dl = "_",
  Al = "__trystero__",
  Ol = {},
  Ll = (e) => {
    if (e.firebaseApp) {
      ...
      return Ol[t] || (Ol[t] = jo(e.firebaseApp));
    }
    return Ol[e.appId] || (Ol[e.appId] = jo(Ve({ databaseURL: e.appId })));
  },
  Fl = (({ init: e, subscribe: t, announce: n }) => {
    const i = {};
    let s,
      r,
      o,
    ...
    return (h, l, c) => {
      const { appId: d } = h;
      if (i[d]?.[l]) return i[d][l];
      const u = {},
        p = {},
        _ = ia(Bo, d, l),
        f = ha(_),
        m = ha(ia(_, $o)),
        g = (async (e, t, n) => crypto.subtle.importKey("raw", await crypto.subtle.digest({ name: "SHA-256" }, ta(`${e}:${t}:${n}`)), { name: oa }, !1, ["encrypt", "decrypt"]))(h.password || "", d, l),
        y = (e) => async (t) => ({ type: t.type, sdp: await e(g, t.sdp) }),
        v = y(ca),
        C = y(la),
        b = () => Tl(!0, h.rtcConfig),
        w = (e, t, n) => {
        ...
        E = (e) => (r.push(...Ho(e, b)), Vo(r.splice(0, e).map((e) => e.offerPromise.then(C).then((t) => ({ peer: e, offer: t }))))),
        T = (e, t) => c?.({ error: `incorrect password (${h.password}) when decrypting ${t}`, appId: d, peerId: e, roomId: l }),
        I = (e) => async (t, n, i) => {
          const [s, r] = await Vo([f, m]);
          if (t !== s && t !== r) return;
          const { peerId: o, offer: a, answer: l, peer: c } = "string" == typeof n ? ra(n) : n;
          if (o !== $o && !p[o])
            if (!o || a || l) {
              if (a) {
                const t = u[o]?.[e];
                if (t && $o > o) return;
                const n = Tl(!1, h.rtcConfig);
                let s;
                n.setHandlers({
                  connect() {
                    return w(n, o, e);
                ...
                try {
                  ...
                  return void T(o, "offer");
                }
                if (n.isDead) return;
                const [r, l] = await Vo([ha(ia(_, o)), n.signal(s)]);
                i(r, sa({ peerId: $o, answer: await C(l) }));
              } else if (l) {
                let t;
                try {
                  t = await v(l);
                } catch (e) {
                  return void T(o, "answer");
                }
                if (c)
                  c.setHandlers({
                    connect() {
                  ...
                  const n = u[o]?.[e];
                  n && !n.isDead && n.signal(t);
                }
              }
            } else {
              if (u[o]?.[e]) return;
              const [[{ peer: t, offer: n }], s] = await Vo([E(1), ha(ia(_, o))]);
              (u[o] ||= []),
                (u[o][e] = t),
                setTimeout(
                  () =>
                ...
                i(s, sa({ peerId: $o, offer: n }));
            }
        };
      if (!h) throw Xo("requires a config map as the first argument");
      if (!d && !h.firebaseApp) throw Xo("config map is missing appId field");
      if (!l) throw Xo("roomId argument required");
      if (!a) {
        const t = e(h);
        (r = Ho(20, b)),
      ...
      const k = s.map(() => 5333),
        x = [],
        N = s.map(async (e, n) => t(await e, await f, await m, I(n), E));
      Vo([f, m]).then(([e, t]) => {
        const i = async (s, r) => {
          const o = await n(s, e, t);
          "number" == typeof o && (k[r] = o), (x[r] = setTimeout(() => i(s, r), k[r]));
        };
        N.forEach(async (e, t) => {
          await e, i(await s[t], t);
        });
      });
      let R = Jo;
      return (
        ...
        (i[d][l] = ((e, t, n) => {
          const i = {},
            ...
            h = {},
            l = {},
            c = { onPeerJoin: Jo, onPeerLeave: Jo, onPeerStream: Jo, onPeerTrack: Jo },
            d = (e, t) =>
              (e ? (Array.isArray(e) ? e : [e]) : Qo(i)).flatMap((e) => {
                const n = i[e];
                return n ? t(e, n) : (console.warn(`${Bo}: no peer with id ${e} found`), []);
              }),
            u = (e) => {
              i[e] && (delete i[e], delete o[e], delete a[e], c.onPeerLeave(e), t(e));
            },
            p = (e) => {
              if (s[e]) return r[e];
              if (!e) throw Xo("action type argument is required");
              const t = ta(e);
              if (t.byteLength > 12) throw Xo(`action type string "${e}" (${t.byteLength}b) exceeds byte limit (12). Hint: choose a shorter name.`);
              ...
              return (
                (s[e] = {
                  onComplete: Jo,
                  onProgress: Jo,
                  setOnComplete: (t) => (s[e] = { ...s[e], onComplete: t }),
                  setOnProgress: (t) => (s[e] = { ...s[e], onProgress: t }),
                  async send(e, t, s, r) {
                    if (s && "object" != typeof s) throw Xo("action meta argument must be an object");
                    const a = typeof e;
                    if ("undefined" === a) throw Xo("action data cannot be undefined");
                    const h = "string" !== a,
                      l = e instanceof Blob,
                      c = l || e instanceof ArrayBuffer || e instanceof kl;
                    if (s && !c) throw Xo("action meta argument can only be used with binary data");
                    const u = c ? new Uint8Array(l ? await e.arrayBuffer() : e) : ta(h ? sa(e) : e),
                      p = s ? ta(sa(s)) : null,
                      _ = Math.ceil(u.byteLength / xl) + (s ? 1 : 0) || 1,
                      f = Ho(_, (e, t) => {
                        const i = t === _ - 1,
                          r = s && 0 === t,
                          a = new Uint8Array(15 + (r ? p.byteLength : i ? u.byteLength - xl * (_ - (s ? 2 : 1)) : xl));
                        return (
                          a.set(n),
                          a.set([o], 12),
                          a.set([i | (r << 1) | (c << 2) | (h << 3)], 13),
                          a.set([Math.round(((t + 1) / _) * Nl)], 14),
                          a.set(s ? (r ? p : u.subarray((t - 1) * xl, t * xl)) : u.subarray(t * xl, (t + 1) * xl), 15),
                          a
                        );
                      });
                    return (
                      ...
                      Vo(
                        d(t, async (e, t) => {
                          ...
                          for (; o < _; ) {
                            const a = f[o];
                            if (
                              (n.bufferedAmount > n.bufferedAmountLowThreshold &&
                                (await new Promise((e) => {
                                  const t = () => {
                                    n.removeEventListener(Rl, t), e();
                                  };
                                  n.addEventListener(Rl, t);
                                })),
                              !i[e])
                            )
                              break;
                            t.sendData(a), o++, r?.(a[14] / Nl, e, s);
                          }
                        })
                      )
                    );
                ...
                (r[e] ||= [s[e].send, s[e].setOnComplete, s[e].setOnProgress])
              );
            },
            _ = (e, t) => {
              const n = new Uint8Array(t),
                i = na(n.subarray(0, 12)).replaceAll("\0", ""),
                [r] = n.subarray(12, 13),
                [a] = n.subarray(13, 14),
                [h] = n.subarray(14, 15),
                l = n.subarray(15),
                ...
                u = !!(4 & a),
                p = !!(8 & a);
              if (!s[i]) return void console.warn(`${Bo}: received message with unregistered type (${i})`);
              (o[e] ||= {}), (o[e][i] ||= {});
              const _ = (o[e][i][r] ||= { chunks: [] });
              if ((d ? (_.meta = ra(na(l))) : _.chunks.push(l), s[i].onProgress(h / Nl, e, _.meta), !c)) return;
              const f = new Uint8Array(_.chunks.reduce((e, t) => e + t.byteLength, 0));
              if ((_.chunks.reduce((e, t) => (f.set(t, e), e + t.byteLength), 0), delete o[e][i][r], u)) s[i].onComplete(f, e, _.meta);
              else {
                const t = na(f);
                s[i].onComplete(p ? ra(t) : t, e);
              }
            },
            f = async () => {
              await I(""),
          ...
          return (
            e((e, t) => {
              i[t] ||
                ...
                e.setHandlers({
                  ...
                  track(e, n) {
                    c.onPeerTrack(e, n, t, l[t]), delete l[t];
                  },
                  signal: (e) => C(e, t),
                  close: () => u(t),
                  error: () => u(t),
            ...
            T((e, t) => (l[t] = e)),
            k((e, t) => u(t)),
            Yo && addEventListener("beforeunload", f),
            {
              makeAction: p,
              leave: f,
              async ping(e) {
                if (!e) throw Xo("ping() must be called with target peer ID");
                const t = Date.now();
                return m("", e), await new Promise((t) => (a[e] = t)), Date.now() - t;
              },
              getPeers: () => Go(Ko(i).map(([e, t]) => [e, t.connection])),
              addStream: (e, t, n) =>
                d(t, async (t, i) => {
                  n && (await w(n, t)), i.addStream(e);
                }),
              removeStream: (e, t) => d(t, (t, n) => n.removeStream(e)),
              addTrack: (e, t, n, i) =>
                d(n, async (n, s) => {
                  i && (await E(i, n)), s.addTrack(e, t);
                }),
              removeTrack: (e, t, n) => d(n, (n, i) => i.removeTrack(e, t)),
              replaceTrack: (e, t, n, i, s) =>
                d(i, async (i, r) => {
                  s && (await E(s, i)), r.replaceTrack(e, t, n);
                }),
          ...
          (e) => delete p[e],
          () => {
            delete i[d][l], x.forEach(clearTimeout), N.forEach(async (e) => (await e)()), clearInterval(o);
          }
        ))
      );
    };
    ...
    subscribe(e, t, n, i) {
      const s = To(e, t),
        ...
        h = (e, t) => {
          const n = (function (e, t) {
            (e = O(e)), Or("push", e._path), Rr("push", t, e._path, !0);
            const n = Vr(e._repo),
              i = mo(n),
              s = To(e, i),
              r = To(e, i);
        ...
        a.push(
          ...
          Ao(r, (e) => {
            ...
            "_" !== t &&
              a.push(
                Ao(e.ref, (e) => {
                  (o[t] ||= {}), e.key in o[t] || ((o[t][e.key] = !0), i(n, e.val(), h), ko(e.ref));
                })
              );
          })
        ),
        () => {
          Oo(s), Oo(r), ko(r), a.forEach((e) => e());
        }
      );
    },
    async announce(e, t, n) {
      const i = To(e, t),
        s = To(i, n);
      await ko(s), xo(s, { [Dl]: { peerId: $o } }), Io(s).remove();
    },
  }),
  Ml = (e, t) => ha(ia(Bo, e.appId, t)).then((t) => new Promise((n) => Do(Eo(Ll(e), `${e.rootPath || Al}/${t}`), (e) => n(Qo(e.val() || {})), { onlyOnce: !0 })));
export { Ml as getOccupants, Fl as joinRoom, $o as selfId };